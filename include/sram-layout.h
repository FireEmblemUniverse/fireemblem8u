...
enum game_save_memory_map {
    ...
    GAMESAVE_OFFSET_WMSTAFF        = GAMESAVE_OFFSET_BONUSCLAIM     + GAMESAVE_SIZE_BONUSCLAIM,
    GAMESAVE_OFFSET_DUNGEON        = GAMESAVE_OFFSET_WMSTAFF        + GAMESAVE_SIZE_WMSTAFF,
...
enum suspend_save_memory_map {
    ...
    SUSPENDSAVE_OFFSET_WMSTAFF        = SUSPENDSAVE_OFFSET_CHAPTERFLAGS   + SUSPENDSAVE_SIZE_CHAPTERFLAGS,
    SUSPENDSAVE_OFFSET_DUNGEON        = SUSPENDSAVE_OFFSET_WMSTAFF        + SUSPENDSAVE_SIZE_WMSTAFF,
