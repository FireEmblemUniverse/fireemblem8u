...
void sub_8033770(ProcPtr);
void sub_8033798(ProcPtr);
void sub_80337B4(ProcPtr);
void sub_80337D4(ProcPtr);
void sub_80337F0(ProcPtr);
void InitPrepScreenUnitsAndCamera(void);
void sub_80338C0(void);
void sub_8033940(ProcPtr);
void sub_8033978(ProcPtr);
int sub_8033BF8(void);
void SALLYCURSOR6C_StartUnitSwap(ProcPtr);
