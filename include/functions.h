...
// ??? sub_8011B90(???);
// ??? sub_8011BA4(???);
void sub_8011C94(int, s8, s8, ProcPtr);
void sub_8011CCC(struct Unit *, int, int, int);
void sub_8011D10(u8, int, int, int);
// ??? sub_8011D60(???);
// ??? sub_8011DF4(???);
// ??? sub_8011EC8(???);
// ??? sub_8011EDC(???);
// ??? sub_8011EF0(???);
void sub_8011F5C(struct Unit *, struct Unit *, int, int, int, struct BattleHit *, s8);
...
// ??? sub_808F0C4(???);
// ??? sub_808F0EC(???);
void sub_808F128(int, int, int, int, int, void *, s8, ProcPtr);
void sub_808F270(void); // ??? (text related)
bool SomeTalkProcExists(void);
// ??? sub_808F2A0(???);
// ??? sub_808F2BC(???);
// ??? sub_808F30C(???);
// ??? sub_808F358(???);
