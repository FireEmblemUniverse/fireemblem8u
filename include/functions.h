...
// ??? sub_807EA50(???);
// ??? sub_807EA60(???);
// ??? MapAnimLevelUp_DrawTexts(???);
// ??? MapAnimLevelUp_DrawStatNum(???);
// ??? GetSomeStatUp(???);
// ??? GetSomeStatBase(???);
// ??? sub_807EDEC(???);
// ??? sub_807EDF8(???);
...
// ??? sub_807EFF0(???);
// ??? StartMapAnimLevelUp(???);
// ??? MapAnimLevelUp_InitLcd(???);
// ??? MapAnimLevelUp_ResetLcd(???);
// ??? MapAnimLevelUp_InitDisplay(???);
// ??? sub_807F2B4(???);
// ??? sub_807F2BC(???);
// ??? MapAnimLevelUp_PullUpWindow(???);
// ??? MapAnimLevelUp_PullOffWindow(???);
// ??? MapAnimLevelUp_DisplayStatUp(???);
// ??? MapAnimLevelUp_PlayMusic(???);
// ??? sub_807F48C(???);
// ??? sub_807F53C(???);
// ??? sub_807F548(???);
// ??? sub_807F55C(???);
