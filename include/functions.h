...
int PrepScreenMenu_OnSupport(struct ProcAtMenu* proc);
...
// ??? sub_8096FEC(???);
// ??? sub_8097008(???);
void SetPrepScreenMenuItem(int index, void* effect_routine, int color, int msg, int msg_rtext);
// ??? sub_80970CC(???);
// ??? sub_809710C(???);
...
// ??? Make6CMenuScroll(???);
// ??? sub_80976AC(???);
void sub_80976CC(int, int, int, int);
// ??? sub_8097700(???);
void sub_8097748(ProcPtr, int, int, int, int);
// ??? sub_80977AC(???);
// ??? sub_80977EC(???);
// ??? sub_8097840(???);
// ??? sub_809788C(???);
...
// ??? LoadAndCheckChComplete(???);
s8 LoadAndCheckChComplete2(int);
...
void LoadTrapStructs(void *sram_dest); /* LoadTrapStructs */
...
void SaveWMStuff(void *sram_dest, void *src); /* SaveWMStaff */
void LoadWMStuff(const void *sram_src, void *src);
