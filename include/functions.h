...
// ??? CopyDirect(???);
// ??? sub_8012F20(???);
void CopyDataWithPossibleUncomp();
int FilterR0ForRawCopy(u32 *);
// ??? sub_8012F98(???);
// ??? sub_8012FB0(???);
// ??? sub_8012FE0(???);
void RegisterObjectTileGraphics(const u8* source, u8* target, int width, int height);
// ??? CopyTileGfxForObj(???);
// ??? sub_8013058(???);
void sub_8013094();
void sub_80130BC();
...
// ??? ArchivePalette(???);
void WriteFadedPaletteFromArchive();
// ??? sub_801378C(???);
// ??? sub_8013794(???);
// ??? sub_8013800(???);
// ??? sub_8013844(???);
...
// ??? sub_80AE790(???);
// ??? sub_80AE7A4(???);
void sub_80AE7C4(void *, int, s16, s16, int, int, int, int, void *);
// ??? sub_80AE86C(???);
// ??? sub_80AE930(???);
// ??? sub_80AE938(???);
// ??? sub_80AE964(???);
