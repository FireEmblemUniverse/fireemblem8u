...
// ??? sub_80285A0(???);
void GetUnitSupportBonuses(struct Unit* unit, struct SupportBonuses* outBonuses);
// ??? sub_80286BC(???);
// ??? sub_80286D4(???);
// ??? sub_80286EC(???);
// ??? sub_8028710(???);
...
// ??? ClearTileMapRect(???);
void MakeUIWindowTileMap_BG0BG1(int xTile, int yTile, int wTile, int hTile, int styleId);
...
void sub_804E8A8(int x, int y, int c);
void sub_804E90C(int x, int y, int c);
// ??? sub_804E98C(???);
// ??? sub_804EA08(???);
// ??? sub_804EA8C(???);
// ??? sub_804EAB8(???);
