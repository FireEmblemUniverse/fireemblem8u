...
// ??? sub_80739E0(???);
// ??? sub_8073A4C(???);
// ??? UiEkrLu_InitLevelUpBox(???);
// ??? UiEkrLu_SetBgs(???);
// ??? sub_8073E48(???);
// ??? UiEkrLu_PutWindowOnScreen(???);
// ??? UiEkrLu_PrepareApGfx(???);
// ??? UiEkrLu_Promo_WindowScroll0(???);
// ??? UiEkrLu_Promo_DrawPromoNewClassName(???);
// ??? UiEkrLu_Promo_WindowScroll1(???);
// ??? UiEkrLu_DrawNewLevel(???);
// ??? UiEkrLu_InitCounterForMainAnim(???);
// ??? UiEkrLu_MainAnime(???);
// ??? UiEkrLu_SetHBlank(???);
// ??? UiEkrLu_DoNothing(???);
// ??? UiEkrLu_PutWindowOffScreen(???);
// ??? UiEkrLu_ResetScreen(???);
// ??? UiEkrLu_OnEnd(???);
// ??? sub_8074580(???);
// ??? sub_8074598(???);
