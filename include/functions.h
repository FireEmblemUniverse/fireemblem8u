...
// ??? sub_80A0900(???);
// ??? sub_80A0924(???);
void StartPrepSupportScreen(int, ProcPtr);
u8 sub_80A095C(int);
// ??? sub_80A098C(???);
// ??? sub_80A09A8(???);
// ??? sub_80A09C4(???);
...
// ??? LoadConvoyItems(???);
// ??? sub_80A32EC(???);
s8 IsExtraLinkArenaEnabled(int);
s8 IsExtraSoundRoomEnabled(void);
s8 IsExtraSupportViewerEnabled(void);
// ??? sub_80A3348(???);
// ??? sub_80A33C4(???);
s8 IsExtraFreeMapEnabled(void);
