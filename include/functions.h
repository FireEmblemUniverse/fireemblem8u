...
// ??? sub_801378C(???);
// ??? sub_8013794(???);
void sub_8013800(int, int, int, int, int, int, int, int, int);
...
const struct UnitDefinition* GetChapterAllyUnitDataPointer(void);
// ??? sub_80833B0(???);
// ??? sub_8083400(???);
// ??? sub_8083424(???);
// ??? sub_8083468(???);
