...
// ??? sub_80055BC(???);
// ??? sub_8005610(???);
ProcPtr NewFace(int faceSlot, int portraitId, int x, int y, int displayType);
...
// ??? sub_8005894(???);
// ??? sub_8005924(???);
void sub_8005988(int, u16*, int, int, s8);
// ??? sub_80059CC(???);
// ??? sub_8005AD4(???);
// ??? sub_8005B04(???);
// ??? sub_8005B68(???);
...
ProcPtr sub_800698C(int, int, const char*, ProcPtr);
...
// ??? sub_8007844(???);
// ??? sub_8007854(???);
void sub_8007938(int, int, int, int, int);
// ??? sub_8007958(???);
// ??? sub_800798C(???);
// ??? sub_80079E4(???);
// ??? sub_8007A3C(???);
...
// ??? LoadSuspendedGame(???);
u8 sub_80A5DA8(int);
void sub_80A5DFC(int index, void *buf);
...
void sub_80A638C(void *sram_dest); /* LoadTrapStructs */
int sub_80A63B0();
int sub_80A63D0();
void sub_80A63E0();
// ??? sub_80A6408(???);
...
// ??? sub_80A7034(???);
// ??? sub_80A7054(???);
void sub_80A7074(void *ptr);
void sub_80A70B0(void *sram_dest, void *src); /* SaveWMStaff */
void sub_80A7138(const void *sram_src, void *src);
...
int CalcSomeChecksum(void *buf, int size);
