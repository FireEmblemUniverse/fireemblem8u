...
// ??? sub_8000E14(???);
// ??? FlushLCDControl(???);
// ??? GetBackgroundControlBuffer(???);
int GetBackgroundTileDataOffset();
// ??? GetTileIndex(???);
// ??? sub_8000FC4(???);
void SetBackgroundTileDataOffset();
void SetBackgroundMapDataOffset();
void SetBackgroundScreenSize();
// ??? sub_800106C(???);
// ??? FlushPalettesAdditive(???);
// ??? FlushPalettesSubstractive(???);
// ??? FlushBackgrounds(???);
void BG_Fill();
// ??? RegisterBlankTile(???);
void SetInterrupt_LCDVBlank(void *func);
...
void ExecMainUpdate();
// ??? _UpdateKeyStatus(???);
void UpdateKeyStatus(void *keyPtr);
// ??? sub_8001414(???);
void ResetKeyStatus(void *keyPtr);
...
// ??? SetupDebugFontForBG(???);
void PrintDebugStringToBG(u16 *bg, u8 *asciiStr);
// ??? sub_800384C(???);
// ??? sub_8003870(???);
// ??? sub_80038B4(???);
...
// ??? Text_AppendStringSimple(???);
// ??? Text_AppendCharSimple(???);
// ??? GetCharTextWidthSimple(???);
// ??? GetStringTextWidthSimple(???);
// ??? sub_8004598(???);
...
// ??? TCS_Free(???);
// ??? TCS_Update(???);
// ??? TCS_RegisterGraphics(???);
// ??? TCS_Exec(???);
// ??? TCS_QueueRotScaleData(???);
// ??? TCS_SetAnim(???);
// ??? TCS_SetROMTCS(???);
// ??? TCS_QueueTileGfx(???);
// ??? TCS_Load(???);
...
// ??? TCSWrapper_OnUpdate(???);
// ??? TCSWrapper_OnDelete(???);
// ??? TCSWrapper_SetParameters(???);
// ??? TCSWrapper_Delete(???);
// ??? DeleteAllTCSWrappers(???);
// ??? DoesTCSWrapperExist(???);
// ??? sub_80097E8(???);
// ??? sub_8009950(???);
// ??? sub_80099E4(???);
...
// ??? sub_800A2A4(???);
// ??? FilterSomeTextFromStandardBuffer(???);
// ??? sub_800A42C(???);
// ??? sub_800A4E8(???);
// ??? sub_800A518(???);
// ??? sub_800A680(???);
...
// ??? GetWeaponRangeMask(???);
// ??? GetUnitRangeMask(???);
// ??? GetUnitStaffRangeMask_0(???);
// ??? GetUnitStaffRangeMask(???);
// ??? GetConvoyTotalGoldValue(???);
// ??? sub_80173D0(???);
// ??? sub_8017450(???);
// ??? sub_8017478(???);
// ??? sub_80174AC(???);
...
// ??? GetItemRange(???);
// ??? GetItemWRank(???);
// ??? GetItemEffectivenessPtr(???);
// ??? GetItemStatBonusesPtr(???);
// ??? GetItemIconId(???);
// ??? GetItemWeaponEffect(???);
// ??? GetItemUseEffect(???);
// ??? GetItemCostPerUse(???);
...
// ??? HasClassWRank(???);
// ??? LoadUnit(???);
// ??? StoreNewUnitFromCode(???);
// ??? CharFillInventoryFromCode(???);
// ??? LoadUnitStats(???);
// ??? FixROMUnitStructPtr(???);
// ??? LoadUnitSupports(???);
// ??? AutolevelUnitWeaponRanks(???);
...
// ??? sub_8028160(???);
// ??? GetROMUnitSupportCount(???);
// ??? GetROMUnitSupportingId(???);
// ??? GetUnitSupportingUnit(???);
// ??? GetSupportLevelBySupportIndex(???);
// ??? GetUnitTotalSupportLevels(???);
// ??? AddSupportPoints(???);
// ??? sub_80282DC(???);
// ??? CanUnitSupportCommandWith(???);
// ??? GetUnitStartingSupportValue(???);
// ??? GetSupportDataIdForOtherUnit(???);
// ??? sub_80283E0(???);
// ??? HandleSupportGains(???);
// ??? GetSupportBonusEntryPtr(???);
...
// ??? sub_8028710(???);
// ??? sub_802873C(???);
// ??? CanUnitsStillSupportThisChapter(???);
// ??? sub_80287A4(???);
// ??? sub_80287D4(???);
// ??? CanUnitUseItem(???);
// ??? sub_8028C0C(???);
...
// ??? WriteBattleStructTerrainBonuses(???);
// ??? BattleSetupTerrainData(???);
// ??? SetupBattleWeaponData(???);
// ??? SetupBattleBallistaWeaponData(???);
// ??? sub_802A958(???);
// ??? FillPreBattleStats(???);
// ??? FillBattleStats(???);
// ??? BattleApplyMiscBonuses(???);
// ??? BattleLoadDefense(???);
// ??? LoadRawDefense(???);
// ??? BattleLoadAttack(???);
// ??? BattleLoadAS(???);
...
// ??? ComputeHit(???);
// ??? ComputeCrit(???);
// ??? ComputeLethalityChance(???);
// ??? BattleApplySRankBonuses(???);
// ??? BattleComputeBuffStatus(???);
// ??? ComputeSpecialWeapons(???);
// ??? ClearRounds(???);
// ??? MakeBattle(???);
// ??? GetBattleUnitPointers(???);
// ??? BattleCheckDoubling(???);
// ??? MakeBattleRound(???);
// ??? GetBattleHitCount(???);
// ??? BattleCheckBrave(???);
...
// ??? sub_80346E0(???);
// ??? GetSomethingRelatedToCurrentDifficulty(???);
// ??? sub_803471C(???);
// ??? NewUnitInfoWindow(???);
...
// ??? LoadNewUIGraphics(???);
// ??? sub_804EB7C(???);
// ??? NewMenu_DefaultAdjusted(???);
// ??? NewMenu_DefaultChild(???);
// ??? sub_804EBD8(???);
// ??? NewMenu_Default(???);
// ??? sub_804EBF4(???);
// ??? NewMenu_804EC34(???);
...
// ??? EndMenu(???);
// ??? EndAllMenus(???);
// ??? Menu_CallDefinedConstructors(???);
// ??? Menu_Draw(???);
// ??? Menu_DrawHoverThing(???);
// ??? Menu_Idle(???);
// ??? Menu_HandleDirectionInputs(???);
// ??? Menu_HandleSelectInputs(???);
// ??? Menu_GetCursorGfxCurrentPosition(???);
// ??? MenuCommand_UsabilityAlways(???);
// ??? UsabilityGrayed(???);
// ??? UsabilityNever(???);
// ??? sub_804F454(???);
// ??? sub_804F458(???);
...
// ??? MarkSomethingInMenu(???);
// ??? sub_804F62C(???);
// ??? NewMenu_AndDoSomethingCommands(???);
// ??? Menu_UpdateMovingCursorGfxPosition(???);
...
// ??? Make6CMOVEUNITForUnit(???);
// ??? MakeMOVEUNITForMapUnit(???);
// ??? sub_80784D8(???);
// ??? MOVEUNIT6C_SetCameraFollow(???);
// ??? MOVEUNIT6C_UnsetCameraFollow(???);
// ??? Make6CMOVEUNITForUI(???);
// ??? sub_8078524(???);
// ??? NewMOVEUNIT(???);
// ??? MOVEUNIT6C_SetSpriteDirection(???);
// ??? MOVEUNIT6C_SetDefaultSpriteDirection(???);
// ??? _MOVEUNIT6C_SetDefaultFacingDirection(???);
// ??? _MOVEUNIT6C_ChangeFutureMovement(???);
// ??? DoesMoveunitExist(???);
// ??? IsThereAMovingMoveunit(???);
// ??? sub_8078770(???);
// ??? MOVEUNIT6C_ChangeFutureMovement(???);
// ??? sub_80787C4(???);
// ??? Init6C_89A2938(???);
// ??? Call89A2938_PlaySound1(???);
// ??? Call89A2938_PlaySound2(???);
// ??? NewSoundStepPlay6C(???);
// ??? __MOVEUNIT6C_PlaySoundStepByClass(???);
// ??? nullsub_19(???);
// ??? Moveunit_ExecMoveCommand(???);
...
// ??? nullsub_54(???);
// ??? MOVU_Call2_Moving(???);
// ??? MOVEUNIT6C_PlaySoundStepByClass(???);
// ??? _6CMOVEUNIT_Loop(???);
// ??? _6CMOVEUNIT_Destructor(???);
// ??? ClearMOVEUNITs(???);
// ??? EndMoveunitMaybe(???);
// ??? Delete6C__(???);
// ??? sub_80790CC(???);
...
// ??? UnblockAll6CMarked4(???);
// ??? sub_80790F8(???);
// ??? IsSomeMOVEUNITRelatedStructAvailable(???);
// ??? ResetAllMoveunitAnims(???);
// ??? GetNextMoveunitEntryStruct(???);
// ??? sub_807920C(???);
// ??? GetMOVEUNITDisplayPosition(???);
// ??? UpdateMOVEUNITGfx_Idle(???);
// ??? UpdateMOVEUNITGfx_Movement(???);
// ??? MOVEUNIT6C_GetMovementSpeed(???);
// ??? sub_807953C(???);
// ??? GetMOVEUNITGraphicsBuffer(???);
// ??? GetMovingMapSpriteGfxPtrFromMOVEUNIT(???);
// ??? MMS_GetROMTCS(???);
// ??? MOVEUNIT6C_807959C(???);
// ??? BlendTimer6C_MainLoop(???);
// ??? sub_8079654(???);
// ??? sub_807968C(???);
// ??? sub_80796D4(???);
// ??? sub_8079730(???);
// ??? sub_8079788(???);
// ??? SetMOVEUNITField40To1(???);
// ??? sub_80797DC(???);
// ??? MOVEUNIT6C_SetDisplayPos(???);
// ??? sub_80797F4(???);
// ??? sub_8079804(???);
// ??? sub_8079858(???);
// ??? sub_807988C(???);
// ??? SetupSomeMoveunitAnim(???);
// ??? TCS_HaltAnim2(???);
// ??? sub_80798E8(???);
// ??? sub_807990C(???);
// ??? MOVEUNIT_Begin20FramesFastAnim(???);
// ??? TCS_HaltAnim(???);
// ??? sub_8079970(???);
// ??? sub_80799A0(???);
// ??? sub_80799A8(???);
...
// ??? sub_8079A74(???);
// ??? sub_8079AD4(???);
// ??? SetAllMOVEUNITField44To1(???);
// ??? SetMOVEUNITField44To1(???);
// ??? ChangeMOVEUNITDataMaybe(???);
// ??? sub_8079B6C(???);
// ??? GetMoveunitByIndex(???);
// ??? GetExistingMoveunitForUnit(???);
// ??? sub_8079BE0(???);
...
// ??? SRAMTransfer(???);
// ??? SaveChecker(???);
// ??? StoreLoadRoutinesToRAM(???);
// ??? SRAMTransfer_WithCheck(???);
// ??? sub_80D188C(???);
