...
// ??? sub_8005894(???);
// ??? sub_8005924(???);
void sub_8005988(int, u16*, int, int, int);
// ??? sub_80059CC(???);
// ??? sub_8005AD4(???);
// ??? sub_8005B04(???);
// ??? sub_8005B68(???);
...
void sub_8005CA4(u16*, int, int, int);
// ??? sub_8005D64(???);
// ??? sub_8005D70(???);
// ??? sub_8005D98(???);
...
// ??? sub_800698C(???);
void sub_8006A30(u32 a, u32 b, u32 c);
// ??? sub_8006A50(???);
// ??? sub_8006A70(???);
void sub_8006A7C(void); // aka EndDialogueInterpreter (face? probably not)
// ??? sub_8006A8C(???);
// ??? sub_8006A98(???);
void sub_8006AA8(u32 a);
// ??? sub_8006ABC(???);
// ??? sub_8006AC8(???);
// ??? sub_8006ADC(???);
void sub_8006AF0(u32 a);
void sub_8006B10(u32 a);
// ??? sub_8006B4C(???);
// ??? sub_8006C00(???);
// ??? sub_8006C34(???);
// ??? sub_8006DA0(???);
...
// ??? sub_8007844(???);
// ??? sub_8007854(???);
void sub_8007938(u8, int, int, int, int);
// ??? sub_8007958(???);
// ??? sub_800798C(???);
// ??? sub_80079E4(???);
// ??? sub_8007A3C(???);
...
// ??? sub_80130BC(???);
// ??? sub_8013104(???);
void sub_8013138(u16 const* src, u8* dst, int, int);
// ??? sub_8013168(???);
// ??? sub_80131A8(???);
// ??? sub_80131B0(???);
// ??? sub_80131C4(???);
...
// ??? sub_8027E4C(???);
// ??? SMS_DisplayOne(???);
void sub_8028014(int, int, int, int, struct Unit*);
// ??? sub_8028100(???);
...
// ??? sub_8031EE4(???);
// ??? sub_8031EF0(???);
s8 sub_8031F50(struct Unit*); // ArenaIsUnitAllowed
// ??? sub_8031F74(???);
// ??? sub_8031FC8(???);
...
s8 sub_803E900(void);
s8 sub_803E93C(u16*);
void sub_803EA58(u8, u8, u16*, u16*, u16*);
// ??? sub_803EBA4(???);
...
s8 IsEventIdMaskedMaybe(int, void*);
// ??? CheckGlobalEventId(???);
void SetEventId(u16);
...
// ??? sub_8084748(???);
// ??? sub_808478C(???);
void *sub_80847F8(); /* return (void*)gSupportTalkList; */
...
// ??? EraseSecureHeader(???);
// ??? CalcSaveDataMagic(???);
// ??? LoadAndVerifySecureHeaderSW(???);
// ??? SaveSecureHeader(???);
// ??? ForceSaveSecureHeader(???);
void ResetSecureHeader(void);
// ??? sub_80A2EA8(???);
// ??? SramOffsetToPointer(???);
// ??? SramPointerToOffset(???);
// ??? SaveMetadata_Check(???);
// ??? SaveMetadata_Generate(???);
// ??? SaveMetadata_Erase(???);
// ??? GetSaveDataLocation(???);
// ??? CheckSaveAndGetPointer(???);
// ??? SaveLocalEventIndexes(???);
// ??? SaveGlobalEventIndexes(???);
void LoadLocalEventIds(const void *sram_src);
// ??? LoadGlobalEventIds(???);
// ??? LoadGlobalEventIds_ret(???);
// ??? SaveConvoyItems(???);
// ??? LoadConvoyItems(???);
// ??? sub_80A32EC(???);
// ??? sub_80A32F0(???);
...
// ??? ReadAndVerifyMiscSaveGameDataAll(???);
// ??? sub_80A38F4(???);
// ??? sub_80A3950(???);
// ??? WriteMiscSaveGameDataAll(???);
// ??? EraseAllGameRankSaveData(???);
// ??? GetChapterDataMode(???);
// ??? GetGameRankSaveData(???);
// ??? WriteMiscGameSavePack(???);
// ??? IsGameRankSaveDataBetter(???);
// ??? GenerateGameRankSaveData(???);
void UpdateGameRankSaveData(void);
// ??? EraseUnkBmSave1(???);
// ??? ReadAndVerifyUnkBmSave1(???);
void WriteUnkBmSave1(void *buf);
// ??? ReadAndVerifyUnkBmSave1Bit(???);
void ModifyUnkBmSave1();
// ??? EraseUnkBmSave2(???);
// ??? ReadAndVerifyUnkBmSave2(???);
// ??? WriteUnkBmSave2(???);
// ??? ReadAndVerifyUnkBmSave2Bit(???);
// ??? ModifyUnkBmSave2(???);
...
// ??? BWL_IncrementWinCount(???);
// ??? BWL_IncrementAndSaveLossCount(???);
// ??? BWL_SetUnitLossInfo(???);
...
// ??? BWL_FavorDecreaseDrastically(???);
// ??? BWL_CalcTotalBattleCount(???);
// ??? BWL_CalcTotalWinCount(???);
// ??? BWL_CalcTotalLossCount(???);
// ??? BWL_CalcTotalLevel(???);
// ??? BWL_CalcTotalExpGain(???);
// ??? GetBwlExpGain(???);
int GetBwlFavoritism(u8 char_id); /* related to BWL */
void BWL_AddFavoritismValue(u8 char_id, int);
void BWL_HandleBattleDiedUnit(void);
// ??? IsPlayThroughIdUnique(???);
// ??? GetNextUniquePlayThroughId(???);
// ??? CountGamePlayThroughTotal(???);
int CountVerifiedPlayThroughTotal(void);
// ??? SetNewPlayThroughIndex(???);
// ??? GetchapterModeIndex(???);
void DeclareCompletedPlaythrough(void);
// ??? CheckSaveSecHead_0F_B0(???);
...
// ??? Save0203EDB4(???);
// ??? Load0203EDB4(???);
// ??? SetSecHeader_slotCur(???);
// ??? GetSecHeader_slotCur(???);
// ??? sub_80A4DC8(???);
// ??? CopyGameSave(???);
// ??? SaveNewGame(???);
// ??? SaveGame(???);
...
// ??? LoadWMStaffBySlot(???);
// ??? loadAndCheckGlobalEventIds(???);
// ??? CheckRamChapterDataUnk(???);
// ??? VerifyAndCheckSavedRamChapterDataUnk(???);
// ??? VerifyAndCheckSavedRamChapterDataFlag5(???);
// ??? SaveUnit(???);
// ??? LoadUnit(???);
// ??? SaveRNGState_Maybe(???);
...
int CheckSecHeader_rB63();
void SetSecHeader_BIT63();
// ??? ReadAndCalcSomeCheckSum(???);
// ??? VerifySaveChunk(???);
// ??? SetSaveChunkCheckSum(???);
// ??? sub_80A6470(???);
// ??? sub_80A6544(???);
// ??? sub_80A654C(???);
// ??? sub_80A6560(???);
...
// ??? _CallDifferedLoop(???);
// ??? Get6CDifferedLoop6C(???);
void DeleteEach6CDifferedLoop(void);
// ??? Find6CDifferedLoop(???);
// ??? sub_80AD364(???);
// ??? sub_80AD434(???);
// ??? sub_80AD43C(???);
...
// ??? sub_80ADC44(???);
// ??? sub_80ADC68(???);
void sub_80ADC90(void);
// ??? sub_80ADCA4(???);
// ??? sub_80ADD24(???);
void sub_80ADDD4(ProcPtr p);
// ??? sub_80ADDF8(???);
// ??? sub_80ADDFC(???);
// ??? sub_80ADE90(???);
// ??? sub_80ADEE0(???);
...
int sub_80B5F9C();
int sub_80B5FD0();
int sub_80B6070(int, int, int, int, int);
// ??? sub_80B60C8(???);
// ??? sub_80B6104(???);
// ??? sub_80B6144(???);
// ??? sub_80B61C4(???);
...
// ??? sub_80BD014(???);
// ??? sub_80BD048(???);
unsigned int GetBattleMapType(void);
// ??? sub_80BD20C(???);
// ??? sub_80BD224(???);
void CpuSetSomeValue(const void *val_ptr, void *dest);
// ??? sub_80BD270(???);
// ??? sub_80BD284(???);
// ??? sub_80BD28C(???);
// ??? sub_80BD29C(???);
