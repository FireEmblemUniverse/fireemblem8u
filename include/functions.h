...
void Text_AppendStringSimple(struct Text *a, char *b);
const char *Text_AppendCharSimple(struct Text *a, const char *b);
char *GetCharTextWidthSimple(char *a, u32 *b);
int GetStringTextWidthSimple();
// ??? sub_8004598(???);
