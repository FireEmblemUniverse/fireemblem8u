...
#define WmEvtShowMU(mu_id, jid, faction, node) _EvtArg0(EV_CMD_PUTSPRITE, 6, 0, 0), _EvtParams2(mu_id, jid), _EvtParams2(faction, node),
#define WmEvtMoveUnit(mu_id, acc, x1, y1, x2, y2, time, flag, delay) _EvtArg0(EV_CMD_WM_PUTMOVINGSPRITE, 12, 0, 0), _EvtParams2(mu_id, acc), _EvtParams2(x1, y1), _EvtParams2(x2, y2), _EvtParams2(time, flag), _EvtParams2(delay, 0),
#define WmEvtWaitMU(mu_id) _EvtArg0(EV_CMD_WM_WAITFORSPRITES, 4, 0, 0), (EventScr)(mu_id),
#define WmEvtRemoveMU(mu_id) _EvtArg0(EV_CMD_WM_REMSPRITE, 4, 0, 0), (EventScr)(mu_id),
#define WmEvtSetPosition(mu_id, x, y) _EvtArg0(EV_CMD_WM_PUTSPRITE, 6, 0, 0), _EvtParams2(mu_id, 0), _EvtParams2(x, y),
#define WmEvtFadeMU(mu_id, delay) _EvtArg0(EV_CMD_WM_FADEINSPRITE, 4, 0, 0), _EvtParams2(mu_id, delay),
...
#define WmEvtInitNextStoryNode _EvtAutoCmdLen2(EV_CMD_WM_CREATENEXTDESTINATION),
