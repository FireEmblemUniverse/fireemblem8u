...
LABEL(0x1)
    ...
    PUTSPRITE(WM_MU_4, CLASS_REVENANT, FACTION_ID_GREEN, WM_NODE_BorderMulan)
    PUTSPRITE(WM_MU_5, CLASS_REVENANT, FACTION_ID_GREEN, WM_NODE_BorderMulan)
    PUTSPRITE(WM_MU_6, CLASS_REVENANT, FACTION_ID_GREEN, WM_NODE_BorderMulan)
    ...
    TEXTCONT
    TEXTEND
    PUTSPRITE(WM_MU_2, CLASS_ARMOR_KNIGHT, FACTION_ID_GREEN, WM_NODE_Serafew)
    WM_FADEINSPRITE(WM_MU_2, 60)
    TEXTCONT
    TEXTEND
    WM_WAITFORSPRITELOAD
