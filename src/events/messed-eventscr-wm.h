...
CONST_DATA EventScr EventScrWM_Ch9a_ChapterIntro[] = {
    ...
    STAL(6)
    STAL(46)
    PUTSPRITE(WM_MU_2, CLASS_SNIPER, FACTION_ID_BLUE, WM_NODE_PortKiris)
...
CONST_DATA EventScr EventScrWM_08A3A9EC[] = {
    ...
    STAL(6)
    STAL(46)
    PUTSPRITE(WM_MU_2, CLASS_SNIPER, FACTION_ID_BLUE, WM_NODE_TerazPlateau)
    WM_FADEINSPRITE(WM_MU_2, 60)
    WM_WAITFORSPRITELOAD
    TEXTCONT
    TEXTEND
    PUTSPRITE(WM_MU_3, CLASS_MERCENARY, FACTION_ID_GREEN, WM_NODE_BorderMulan)
    PUTSPRITE(WM_MU_4, CLASS_MERCENARY, FACTION_ID_GREEN, WM_NODE_BorderMulan)
...
CONST_DATA EventScr EventScrWM_08A3AD40[] = {
    ...
    TEXTCONT
    TEXTEND
    PUTSPRITE(WM_MU_2, CLASS_HERO, FACTION_ID_GREEN, WM_NODE_JehannaHall)
    WM_FADEINSPRITE(WM_MU_2, 60)
    WM_WAITFORSPRITELOAD
    TEXTCONT
    TEXTEND
...
CONST_DATA EventScr EventScrWM_08A3AF30[] = {
    ...
    TEXTEND
    WM_WAITFORSPRITELOAD
    PUTSPRITE(WM_MU_2, CLASS_WARRIOR, FACTION_ID_GREEN, WM_NODE_FortRigwald)
    WM_FADEINSPRITE(WM_MU_2, 60)
    TEXTCONT
    TEXTEND
    WM_WAITFORSPRITELOAD
...
CONST_DATA EventScr EventScrWM_08A3B338[] = {
    ...
    TEXTCONT
    TEXTEND
    PUTSPRITE(WM_MU_2, CLASS_GENERAL, FACTION_ID_GREEN, WM_NODE_GradoKeep)
    WM_FADEINSPRITE(WM_MU_2, 60)
    TEXTCONT
    TEXTEND
    WM_WAITFORSPRITELOAD
...
CONST_DATA EventScr EventScrWM_08A3B678[] = {
    ...
    STAL(6)
    PUTSPRITE(WM_MU_2, CLASS_PALADIN, FACTION_ID_GREEN, WM_NODE_RenaisCastle)
    WM_FADEINSPRITE(WM_MU_2, 60)
    STAL(46)
    WM_WAITFORSPRITELOAD
    TEXTCONT
...
CONST_DATA EventScr EventScrWM_08A3B808[] = {
    ...
    TEXTCONT
    TEXTEND
    PUTSPRITE(WM_MU_2, CLASS_NECROMANCER, FACTION_ID_GREEN, WM_NODE_NarubeRiver)
    TEXTCONT
    TEXTEND
    WM_FADEINSPRITE(WM_MU_2, 60)
    WM_WAITFORSPRITELOAD
...
CONST_DATA EventScr EventScrWM_08A3B944[] = {
    ...
    WM_CLEARPORTRAIT(0, 0x0200, 0)
    STAL(46)
    PUTSPRITE(WM_MU_2, CLASS_GORGONEGG, FACTION_ID_GREEN, WM_NODE_NelerasPeak)
    PUTSPRITE(WM_MU_3, CLASS_GORGONEGG, FACTION_ID_GREEN, WM_NODE_NelerasPeak)
    PUTSPRITE(WM_MU_4, CLASS_GORGONEGG, FACTION_ID_GREEN, WM_NODE_NelerasPeak)
...
CONST_DATA EventScr EventScrWM_08A3BC8C[] = {
    ...
    WM_WAITFORSPRITELOAD
    STAL(45)
    PUTSPRITE(WM_MU_2, CLASS_MANAKETE_2, FACTION_ID_GREEN, WM_NODE_BlackTemple)
    WM_FADEINSPRITE(WM_MU_2, 60)
    TEXTCONT
    TEXTEND
    WM_WAITFORSPRITELOAD
