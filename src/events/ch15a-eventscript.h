...
CONST_DATA EventListScr EventScr_089F6484[] = {
    ...
    SVAL(EVT_SLOT_3, ITEM_DARK_GLEIPNIR)
    GIVE_ITEM(CHARACTER_EIRIKA)
    CALL(EventScr_RemoveBGIfNeeded)
    SVAL(EVT_SLOT_3, ITEM_AXE_GARM)
    GIVE_ITEM(CHARACTER_EIRIKA)
    GOTO(0x1)
LABEL(0x0)
    TEXTSHOW(0xb28)
    ...
    REMA
    CALL(EventScr_RemoveBGIfNeeded)
    SVAL(EVT_SLOT_3, ITEM_SWORD_AUDHULMA)
    GIVE_ITEM(CHARACTER_EPHRAIM)
    CALL(EventScr_RemoveBGIfNeeded)
    SVAL(EVT_SLOT_3, ITEM_ANIMA_EXCALIBUR)
    GIVE_ITEM(CHARACTER_EPHRAIM)
LABEL(0x1)
    FADI(16)
    CLEA
...
CONST_DATA EventListScr EventScr_089F65C8[] = {
    ...
    MUNO
    CALL(EventScr_RemoveBGIfNeeded)
    SVAL(EVT_SLOT_3, ITEM_MASTERSEAL)
