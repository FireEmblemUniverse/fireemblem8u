...
LABEL(0x1)
    ...
    GiveItemTo(CHAR_EVT_PLAYER_LEADER, ITEM_GUIDINGRING)
LABEL(0x2)
    ENUT(219)
    ENUT(189)
    ENUT(187)
...
CONST_DATA EventListScr EventScr_089F2170[] = {
    ...
    MUNO
    CALL(EventScr_RemoveBGIfNeeded)
    GiveItemTo(CHAR_EVT_ACTIVE_UNIT, ITEM_SWORD_ARMORSLAYER)
...
CONST_DATA EventListScr EventScr_089F21BC[] = {
    ...
    MUNO
    CALL(EventScr_RemoveBGIfNeeded)
    GiveItemTo(CHAR_EVT_ACTIVE_UNIT, ITEM_BOOSTER_DEF)
    EVBIT_T(7)
    ENDA
};
...
CONST_DATA EventListScr EventScr_089F21F8[] = {
    ...
    MUNO
    CALL(EventScr_RemoveBGIfNeeded)
    GiveItemTo(CHAR_EVT_ACTIVE_UNIT, ITEM_BOOSTER_SKL)
    EVBIT_T(7)
    ENDA
};
...
CONST_DATA EventListScr EventScr_089F2234[] = {
    ...
    CALL(EventScr_RemoveBGIfNeeded)
    GiveItemTo(CHAR_EVT_ACTIVE_UNIT, ITEM_TORCH)
    MUNO
    EVBIT_T(7)
    ENDA
};
