...
CONST_DATA EventScr EventScrWM_Prologue_Beginning[] = {
    ...
    STAL(60)
    PUTSPRITE(WM_MU_2, CLASS_SOLDIER, FACTION_ID_GREEN, WM_NODE_GradoKeep)
    ...
    STAL(6)
    STAL(60)
    PUTSPRITE(WM_MU_2, CLASS_EPHRAIM_LORD, FACTION_ID_BLUE, WM_NODE_AdlasPlains)
    ...
    WM_CLEARPORTRAIT(0, 0x0200, 0)
    STAL(46)
    PUTSPRITE(WM_MU_6, CLASS_EIRIKA_LORD, FACTION_ID_BLUE, WM_NODE_RenaisCastle)
    PUTSPRITE(WM_MU_5, CLASS_PEER, FACTION_ID_BLUE, WM_NODE_RenaisCastle)
    ...
    PUTSPRITE(WM_MU_4, CLASS_WYVERN_KNIGHT, FACTION_ID_GREEN, WM_NODE_GradoKeep)
