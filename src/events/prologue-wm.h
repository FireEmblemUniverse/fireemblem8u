...
CONST_DATA EventScr EventScrWM_Prologue_Beginning[] = {
    ...
    WM_SPAWNLORD(WM_MU_0, CHARACTER_EIRIKA, WM_NODE_00)
    ...
    STAL(62)
    WM_PLACEDOT(0, 0, WM_NODE_14, 1)
    WM_PLACEDOT(0, 1, WM_NODE_12, 1)
    STAL(60)
    PUTSPRITE(WM_MU_2, CLASS_SOLDIER, FACTION_ID_GREEN, WM_NODE_12)
    PUTSPRITE(WM_MU_3, CLASS_SOLDIER, FACTION_ID_GREEN, WM_NODE_12)
    PUTSPRITE(WM_MU_4, CLASS_SOLDIER, FACTION_ID_GREEN, WM_NODE_12)
    ...
    STAL(6)
    STAL(60)
    PUTSPRITE(WM_MU_2, CLASS_EPHRAIM_LORD, FACTION_ID_BLUE, WM_NODE_06)
    ...
    WM_CLEARPORTRAIT(0, 0x0200, 0)
    STAL(46)
    PUTSPRITE(WM_MU_6, CLASS_EIRIKA_LORD, FACTION_ID_BLUE, WM_NODE_14)
    PUTSPRITE(WM_MU_5, CLASS_PEER, FACTION_ID_BLUE, WM_NODE_14)
    PUTSPRITE(WM_MU_2, CLASS_GENERAL, FACTION_ID_GREEN, WM_NODE_12)
    PUTSPRITE(WM_MU_3, CLASS_MAGE_KNIGHT_F, FACTION_ID_GREEN, WM_NODE_12)
    PUTSPRITE(WM_MU_4, CLASS_WYVERN_KNIGHT, FACTION_ID_GREEN, WM_NODE_12)
...
CONST_DATA EventScr EventScrWM_Prologue_Ending[] = {
    EVBIT_MODIFY(0x1)
    ENUT(137)
    ENDA
};
