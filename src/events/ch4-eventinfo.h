...
CONST_DATA EventListScr EventListScr_Ch4_Turn[] = {
    TURN(0, EventScr_Ch4_0, 2, 0, FACTION_GREEN)
    TURN(0, EventScr_Ch4_4, 2, 0, FACTION_BLUE)
    TURN(EVFLAG_TMP(8), EventScr_Ch4_6, 1, 255, FACTION_BLUE)
    END_MAIN
};
...
CONST_DATA EventListScr EventListScr_Ch4_Location[] = {
    Village(0, EventScr_Ch4_2, 1, 11)
    Village(0, EventScr_Ch4_3, 8, 2)
    END_MAIN
};

CONST_DATA EventListScr EventListScr_Ch4_Misc[] = {
    DefeatAll(EventScr_Ch4_1)
    AREA(EVFLAG_TMP(7), EventScr_Ch4_5, 0, 9, 14, 14)
...
CONST_DATA struct ChapterEventGroup Ch4Events = {
    ...
    .playerUnitsChoice1InEncounter = UnitDef_Ch4Ally_4,
    .playerUnitsChoice2InEncounter = UnitDef_Ch4SkirmishAlly2,
    .playerUnitsChoice3InEncounter = UnitDef_Ch4Ally_5,

    .enemyUnitsChoice1InEncounter = UnitDef_Ch4Enemy_3,
    .enemyUnitsChoice2InEncounter = UnitDef_Ch4Enemy_4,
    .enemyUnitsChoice3InEncounter = UnitDef_Ch4Enemy_5,

    .beginningSceneEvents = EventScr_Ch4_BeginningScene,
    .endingSceneEvents    = EventScr_Ch4_1,
};
