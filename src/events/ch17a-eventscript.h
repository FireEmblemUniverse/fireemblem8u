...
LABEL(0x1f)
    ...
    GiveItemTo(CHAR_EVT_PLAYER_LEADER, ITEM_BOW_NIDHOGG)
    CALL(EventScr_RemoveBGIfNeeded)
    GiveItemTo(CHAR_EVT_PLAYER_LEADER, ITEM_LANCE_VIDOFNIR)
...
LABEL(0x33)
    ...
    MUNO
    CALL(EventScr_RemoveBGIfNeeded)
    GiveItemTo(CHAR_EVT_PLAYER_LEADER, ITEM_STAFF_RESCUE)
LABEL(0x34)
    ENDA
};
