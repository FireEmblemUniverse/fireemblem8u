@ FE6 ROM Header Data
@ Disassembled from the extracted binary block at 0xB1A0BC
@ This block contains the standard Nintendo GBA logo followed by the Game Title ("FIREEMBLEM6")
@ and other standard ROM header metadata for FE6, which is heavily reused/referenced by the link arena or SIO communication features.

@ Standard GBA Nintendo Logo (compressed)
...
RomHeaderFE6GameTitle:
	.ascii "FIREEMBLEM6\0"

RomHeaderFE6GameCode:
	.ascii "AFEJ"

RomHeaderFE6MakerCode:
	.ascii "01"

RomHeaderFE6Magic:
	.byte 0x96

RomHeaderFE6MainUnitCode:
	.byte 0

RomHeaderFE6DeviceType:
	.byte 0

RomHeaderFE6Reserved1:
	.space 7

RomHeaderFE6SoftwareVersion:
	.byte 0

RomHeaderFE6Checksum:
	.byte 0xCC

RomHeaderFE6Reserved2:
	.space 2
