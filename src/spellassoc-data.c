...
#define SPELL_ASSOC_DATA(_item, _count, _type, _pcmd, _stat, _facing, _color)   \
{                                                                               \
    .item           = _item,                                                    \
    .count          = _count,                                                   \
    .type           = _type,                                                    \
...
#define SPELL_ASSOC_DATA_WPN(_item, _type)  \
    SPELL_ASSOC_DATA(_item, 2, _type, NULL, true, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL)

#define SPELL_ASSOC_DATA_WPN_MAGIC(_item, _type, flash_color)   \
    SPELL_ASSOC_DATA(_item, 2, _type, NULL, true, MA_FACING_OPPONENT, flash_color)
...
CONST_DATA struct SpellAssoc gSpellAssocData[] = {
    ...
    SPELL_ASSOC_DATA_WPN(ITEM_LANCE_JAVELIN, SPELL_ASSOC_MCOLOR_ICE),
    ...
    SPELL_ASSOC_DATA_WPN(ITEM_LANCE_SHORTSPEAR, SPELL_ASSOC_MCOLOR_ICE),
    ...
    SPELL_ASSOC_DATA_WPN(ITEM_BOW_IRON, SPELL_ASSOC_MCOLOR_FIRE),
    SPELL_ASSOC_DATA_WPN(ITEM_BOW_STEEL, SPELL_ASSOC_MCOLOR_FIRE),
    SPELL_ASSOC_DATA_WPN(ITEM_BOW_SILVER, SPELL_ASSOC_MCOLOR_FIRE),
    SPELL_ASSOC_DATA_WPN(ITEM_BOW_VENIN, SPELL_ASSOC_MCOLOR_FIRE),
    SPELL_ASSOC_DATA_WPN(ITEM_BOW_KILLER, SPELL_ASSOC_MCOLOR_FIRE),
    SPELL_ASSOC_DATA_WPN(ITEM_BOW_BRAVE, SPELL_ASSOC_MCOLOR_FIRE),
    SPELL_ASSOC_DATA_WPN(ITEM_BOW_SHORTBOW, SPELL_ASSOC_MCOLOR_FIRE),
    SPELL_ASSOC_DATA_WPN(ITEM_BOW_LONGBOW, SPELL_ASSOC_MCOLOR_FIRE),
    SPELL_ASSOC_DATA_WPN(ITEM_UNK_C7, SPELL_ASSOC_MCOLOR_FIRE),
