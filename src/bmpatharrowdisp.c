...
void sub_80329EC(s8 arg1) {
    if (gUnknown_0859DBA0.proc->u2c >= arg1) {
        s8 i;
        gUnknown_0859DBA0.proc->u2c = arg1 - 1;
        gUnknown_0859DBA0.proc->pathCosts[gUnknown_0859DBA0.proc->u2c] =
            gUnknown_0859DBA0.proc->u2b;
        for (i = 1; i <= gUnknown_0859DBA0.proc->u2c; i++) {
