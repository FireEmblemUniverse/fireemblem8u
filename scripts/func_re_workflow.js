...
4. Set confidence: "high" ONLY if the purpose is clear and the name is well-supported by the code; "medium" if reasonably inferable; "low" if you genuinely cannot tell (then leave "new" empty).
