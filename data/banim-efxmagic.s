...
ProcScr_efxFimbulvetr:  @ 0x085D5658
        @ PROC_NAME
        .short 0x1, 0x0
        .word 0x80dce4c
        @ PROC_REPEAT
...
ProcScr_efxFimbulvetrBGTR:  @ 0x085D5670
        @ PROC_NAME
        .short 0x1, 0x0
        .word 0x80dce5c
        @ PROC_REPEAT
...
ProcScr_efxMistyrainOBJ:  @ 0x085D5A68
        @ PROC_NAME
        .short 0x1, 0x0
        .word 0x80dd13c
        @ PROC_SET_END_CB
...
ProcScr_efxHazymoonOBJ2:  @ 0x085D65AC
        @ PROC_NAME
        .short 0x1, 0x0
        .word 0x80dd6b0
        @ PROC_SET_END_CB
...
ProcScr_efxFenrirBGCOL:  @ 0x085D667C
        @ PROC_NAME
        .short 0x1, 0x0
        .word 0x80dd6fc
        @ PROC_MARK
...
ProcScr_efxFenrirBG2:  @ 0x085D66BC
        @ PROC_NAME
        .short 0x1, 0x0
        .word 0x80dd75c
        @ PROC_REPEAT
...
ProcScr_efxFenrirOBJ2:  @ 0x085D686C
        @ PROC_NAME
        .short 0x1, 0x0
        .word 0x80dd86c
        @ PROC_REPEAT
