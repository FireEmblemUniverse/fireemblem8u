...
TileConfiguration2: @0x81aa140
	...
	.align 2, 0
	.global TileConfiguration
TileConfiguration: @0x81ab69c
	.incbin "graphics/map/TileConfiguration.bin.lz"
...
AnotherShrinePalette: @0x81ad070
	...
	.align 2, 0
	.global MapPalette
MapPalette: @0x81ad1b0
	.incbin "graphics/map/MapPalette.gbapal"
...
PrologueMapChanges: @0x8a1e0f8
	.include "src/data/map/PrologueMapChanges.inc"

	.align 2, 0
	.global Ch1MapChanges
Ch1MapChanges: @0x8a1e104
	.include "src/data/map/Ch1MapChanges.inc"
...
Ch2TileChanges: @0x8a1e160
	.include "src/data/map/Ch2TileChanges.inc"
...
Ch3MapChanges: @0x8a1e1f4
	.include "src/data/map/Ch3MapChanges.inc"
...
Ch4MapChanges: @0x8a1e2ac
	.include "src/data/map/Ch4MapChanges.inc"
...
Ch5MapChanges: @0x8a1e338
	.include "src/data/map/Ch5MapChanges.inc"
...
Ch5XMapChanges: @0x8a1e3ac
	.include "src/data/map/Ch5XMapChanges.inc"
...
Ch6MapChanges: @0x8a1e3f0
	.include "src/data/map/Ch6MapChanges.inc"

	.align 2, 0
	.global Ch7MapChanges
Ch7MapChanges: @0x8a1e414
	.include "src/data/map/Ch7MapChanges.inc"
...
Ch8MapChanges: @0x8a1e450
	.include "src/data/map/Ch8MapChanges.inc"
...
Ch9EirikaMapChanges: @0x8a1e4cc
	.include "src/data/map/Ch9EirikaMapChanges.inc"
...
Ch10EirikaMapChanges: @0x8a1e514
	.include "src/data/map/Ch10EirikaMapChanges.inc"
...
Ch11EirikaMapChanges: @0x8a1e568
	.include "src/data/map/Ch11EirikaMapChanges.inc"
...
Ch12EirikaMapChanges: @0x8a1e5b8
	.include "src/data/map/Ch12EirikaMapChanges.inc"

	.align 2, 0
	.global Ch13EirikaMapChanges
Ch13EirikaMapChanges: @0x8a1e5f4
	.include "src/data/map/Ch13EirikaMapChanges.inc"
...
Ch14EirikaMapChanges: @0x8a1e798
	.include "src/data/map/Ch14EirikaMapChanges.inc"
...
Ch15MapChanges: @0x8a1e860
	.include "src/data/map/Ch15MapChanges.inc"
...
Ch16MapChanges: @0x8a1e8b0
	.include "src/data/map/Ch16MapChanges.inc"
...
Ch17MapChanges: @0x8a1e938
	.include "src/data/map/Ch17MapChanges.inc"

	.align 2, 0
	.global Ch18MapChanges
Ch18MapChanges: @0x8a1e974
	.include "src/data/map/Ch18MapChanges.inc"
...
Ch19MapChanges: @0x8a1e990
	.include "src/data/map/Ch19MapChanges.inc"

	.align 2, 0
	.global Ch20MapChanges
Ch20MapChanges: @0x8a1e9f0
	.include "src/data/map/Ch20MapChanges.inc"
...
FinalChapterMap1Changes: @0x8a1ea08
	.include "src/data/map/FinalChapterMap1Changes.inc"

	.align 2, 0
	.global FinalChapterMap2Changes
FinalChapterMap2Changes: @0x8a1ea44
	.include "src/data/map/FinalChapterMap2Changes.inc"
...
Ch9EphMapChanges: @0x8a1ea6c
	.include "src/data/map/Ch9EphMapChanges.inc"
...
Ch10EphraimMapChanges: @0x8a1eaf0
	.include "src/data/map/Ch10EphraimMapChanges.inc"
...
Ch11EphraimMapChanges: @0x8a1ee28
	.include "src/data/map/Ch11EphraimMapChanges.inc"

	.align 2, 0
	.global Ch11EphraimMapChanges_change_0
Ch11EphraimMapChanges_change_0: @0x8a1ee64
	.incbin "graphics/map/Ch11EphraimMapChanges_change_0.bin"

	.align 2, 0
	.global Ch11EphraimMapChanges_change_1
Ch11EphraimMapChanges_change_1: @0x8a1ee70
	.incbin "graphics/map/Ch11EphraimMapChanges_change_1.bin"

	.align 2, 0
	.global Ch11EphraimMapChanges
Ch11EphraimMapChanges: @0x8a1ee74
	.include "src/data/map/Ch11EphraimMapChanges.inc"
...
Ch13EphraimMapChanges: @0x8a1eec8
	.include "src/data/map/Ch13EphraimMapChanges.inc"
...
Ch14EphraimMapChanges: @0x8a1ef58
	.include "src/data/map/Ch14EphraimMapChanges.inc"

	.align 2, 0
	.global TowerOfValni1MapChanges
TowerOfValni1MapChanges: @0x8a1f0f4
	.include "src/data/map/TowerOfValni1MapChanges.inc"

	.align 2, 0
	.global TowerOfValni2MapChanges
TowerOfValni2MapChanges: @0x8a1f100
	.include "src/data/map/TowerOfValni2MapChanges.inc"
...
TowerOfValni3MapChanges: @0x8a1f110
	.include "src/data/map/TowerOfValni3MapChanges.inc"

	.align 2, 0
	.global TowerOfValni4MapChanges
TowerOfValni4MapChanges: @0x8a1f128
	.include "src/data/map/TowerOfValni4MapChanges.inc"
...
TowerOfValni5MapChanges: @0x8a1f138
	.include "src/data/map/TowerOfValni5MapChanges.inc"
...
TowerOfValni6MapChanges: @0x8a1f20c
	.include "src/data/map/TowerOfValni6MapChanges.inc"
...
TowerOfValni7MapChanges: @0x8a1f344
	.include "src/data/map/TowerOfValni7MapChanges.inc"
...
TowerOfValni8MapChanges: @0x8a1f390
	.include "src/data/map/TowerOfValni8MapChanges.inc"
...
LagdouRuins1MapChanges: @0x8a1f3c4
	.include "src/data/map/LagdouRuins1MapChanges.inc"
...
LagdouRuins2MapChanges: @0x8a1f3e8
	.include "src/data/map/LagdouRuins2MapChanges.inc"
...
LagdouRuins3MapChanges: @0x8a1f43c
	.include "src/data/map/LagdouRuins3MapChanges.inc"
...
LagdouRuins4MapChanges: @0x8a1f5c0
	.include "src/data/map/LagdouRuins4MapChanges.inc"
...
LagdouRuins5MapChanges: @0x8a1f6c4
	.include "src/data/map/LagdouRuins5MapChanges.inc"
...
LagdouRuins6MapChanges: @0x8a1f71c
	.include "src/data/map/LagdouRuins6MapChanges.inc"
...
LagdouRuins7MapChanges: @0x8a1f764
	.include "src/data/map/LagdouRuins7MapChanges.inc"
...
LagdouRuins8MapChanges: @0x8a1f830
	.include "src/data/map/LagdouRuins8MapChanges.inc"
...
LagdouRuins9MapChanges: @0x8a1f8f0
	.include "src/data/map/LagdouRuins9MapChanges.inc"
...
LagdouRuins10MapChanges: @0x8a1f918
	.include "src/data/map/LagdouRuins10MapChanges.inc"

	.align 2, 0
	.global LordsSplitMapChanges
LordsSplitMapChanges: @0x8a1f930
	.include "src/data/map/LordsSplitMapChanges.inc"

	.align 2, 0
	.global MelkaenCoastMapChanges
MelkaenCoastMapChanges: @0x8a1f93c
	.include "src/data/map/MelkaenCoastMapChanges.inc"
...
RenaisThroneMapChanges: @0x8a1fa70
	.include "src/data/map/RenaisThroneMapChanges.inc"
...
GradoPrisonMapChanges: @0x8a1fa90
	.include "src/data/map/GradoPrisonMapChanges.inc"
...
GradoShrineMapChangesPast: @0x8a1fab0
	.include "src/data/map/GradoShrineMapChangesPast.inc"
...
RenaisShrineMapChanges: @0x8a1fadc
	.include "src/data/map/RenaisShrineMapChanges.inc"
