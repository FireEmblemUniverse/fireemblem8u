...
$(DATA_SRC_SUBDIR)/map/data_map_change.o: data_dep += $(MAP_CHANGE_TARGETS)

$(DATA_SRC_SUBDIR)/map/data_map_anim.o: data_dep += $(MAP_OBJ_ANIM_TARGETS) $(MAP_PAL_ANIM_TARGETS)
