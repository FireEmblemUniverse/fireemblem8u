...
BeginMapAnimForSummonDK: @ 0x0807B798
	...
	bl SetupMapBattleAnim
	ldr r0, _0807B7EC  @ ProcScr_MapAnimSumDK
	movs r1, #3
	bl Proc_Start
	pop {r0}
	bx r0
...
_0807B7EC: .4byte ProcScr_MapAnimSumDK
...
_0807B870:
	...
	cmp r0, #0
	bne _0807B8C0
	ldr r0, _0807B8BC  @ ProcScr_MapBattleAnim
	movs r1, #3
	bl Proc_Start
	b _0807B8C8
	.align 2, 0
...
_0807B8BC: .4byte ProcScr_MapBattleAnim
_0807B8C0:
	ldr r0, _0807B8D0  @ ProcScr_EventMapBattleAnim
	movs r1, #3
	bl Proc_Start
_0807B8C8:
	pop {r4, r5, r6}
	...
	bx r0
	.align 2, 0
_0807B8D0: .4byte ProcScr_EventMapBattleAnim
...
sub_807BE1C: @ 0x0807BE1C
	...
	adds r6, r6, r1
	ldr r0, [r6]
	ldr r6, _0807BEEC  @ gGenericBuffer
	adds r1, r6, #0
	bl CopyDataWithPossibleUncomp
	ldrb r0, [r5, #0x11]
	lsls r0, r0, #5
...
_0807BEEC: .4byte gGenericBuffer
