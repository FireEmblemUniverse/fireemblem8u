...
_0807AB30: .4byte gGameState
_0807AB34:
	ldrb r1, [r1]
	cmp r1, #0
	beq _0807AB5A
	ldr r0, _0807AB6C  @ gGameState
	movs r2, #0xe
	ldrsh r4, [r0, r2]
	adds r2, r5, #0
	mov r3, sp
...
sub_807BE1C: @ 0x0807BE1C
	...
	adds r6, r6, r1
	ldr r0, [r6]
	ldr r6, _0807BEEC  @ _gGenericBuffer
	adds r1, r6, #0
	bl CopyDataWithPossibleUncomp
	ldrb r0, [r5, #0x11]
	lsls r0, r0, #5
...
_0807BEEC: .4byte _gGenericBuffer
...
_0807CEB8:
	...
	adds r1, r1, r0
	ldr r0, [r1]
	ldr r6, _0807CF24  @ _gGenericBuffer
	adds r1, r6, #0
	bl CopyDataWithPossibleUncomp
...
_0807CF24: .4byte _gGenericBuffer
...
_0807D5D8:
	...
	adds r1, r1, r0
	ldr r0, [r1]
	ldr r4, _0807D660  @ _gGenericBuffer
	adds r1, r4, #0
	bl CopyDataWithPossibleUncomp
...
_0807D660: .4byte _gGenericBuffer
...
_0807E2BE:
	...
	adds r1, r1, r0
	ldr r0, [r1]
	ldr r6, _0807E328  @ _gGenericBuffer
	adds r1, r6, #0
	bl CopyDataWithPossibleUncomp
...
_0807E328: .4byte _gGenericBuffer
...
sub_807E390: @ 0x0807E390
	...
	ldr r1, _0807E3F8  @ _gGenericBuffer
...
_0807E3F8: .4byte _gGenericBuffer
...
sub_807EA98: @ 0x0807EA98
	...
	ldr r4, _0807EB90  @ _gGenericBuffer
	adds r1, r4, #0
	bl CopyDataWithPossibleUncomp
	movs r2, #0xe0
	lsls r2, r2, #2
...
_0807EB90: .4byte _gGenericBuffer
...
_0807F9C8:
	...
	adds r0, r0, r1
	ldr r0, [r0]
	ldr r4, _0807FA90  @ _gGenericBuffer
	adds r1, r4, #0
	bl CopyDataWithPossibleUncomp
...
_0807FA90: .4byte _gGenericBuffer
...
sub_807FAA0: @ 0x0807FAA0
	...
	adds r0, r0, r1
	ldr r0, [r0]
	ldr r1, _0807FB78  @ _gGenericBuffer
	mov r8, r1
	bl CopyDataWithPossibleUncomp
...
_0807FB78: .4byte _gGenericBuffer
...
_0807FE58:
	...
	adds r0, r0, r1
	ldr r0, [r0]
	ldr r4, _0807FFE0  @ _gGenericBuffer
	adds r1, r4, #0
	bl CopyDataWithPossibleUncomp
...
_0807FFE0: .4byte _gGenericBuffer
...
_08080154:
	...
	adds r0, r4, r0
	ldr r0, [r0]
	ldr r6, _08080248  @ _gGenericBuffer
	adds r1, r6, #0
	bl CopyDataWithPossibleUncomp
...
_08080248: .4byte _gGenericBuffer
...
sub_8080498: @ 0x08080498
	...
	adds r0, r5, r0
	ldr r0, [r0]
	ldr r1, _08080524  @ _gGenericBuffer
	mov r9, r1
	bl CopyDataWithPossibleUncomp
...
_08080524: .4byte _gGenericBuffer
...
sub_8080530: @ 0x08080530
	...
	adds r4, r4, r6
	ldr r0, [r4]
	ldr r4, _080805A0  @ _gGenericBuffer
	adds r1, r4, #0
	bl CopyDataWithPossibleUncomp
...
_080805A0: .4byte _gGenericBuffer
...
_08080E0E:
	...
	adds r1, r1, r0
	ldr r0, [r1]
	ldr r6, _08080E78  @ _gGenericBuffer
	adds r1, r6, #0
	bl CopyDataWithPossibleUncomp
...
_08080E78: .4byte _gGenericBuffer
...
_08080F92:
	...
	adds r1, r1, r0
	ldr r0, [r1]
	ldr r6, _08080FFC  @ _gGenericBuffer
	adds r1, r6, #0
	bl CopyDataWithPossibleUncomp
...
_08080FFC: .4byte _gGenericBuffer
...
_08081134:
	...
	adds r1, r1, r0
	ldr r0, [r1]
	ldr r6, _080811A0  @ _gGenericBuffer
	adds r1, r6, #0
	bl CopyDataWithPossibleUncomp
...
_080811A0: .4byte _gGenericBuffer
