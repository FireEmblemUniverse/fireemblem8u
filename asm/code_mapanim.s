...
DisplayWpnBrokePopup: @ 0x0807A72C
	...
	adds r6, r0, #0
	movs r4, #0
	ldr r5, _0807A768  @ gUnknown_0203A4EC
	adds r0, r5, #0
	...
	adds r4, r5, #0
_0807A742:
	ldr r5, _0807A76C  @ gUnknown_0203A56C
	adds r0, r5, #0
	bl BattleUnit_ShouldDisplayWpnBroke
	lsls r0, r0, #0x18
	cmp r0, #0
...
_0807A762:
	...
	bx r0
	.align 2, 0
_0807A768: .4byte gUnknown_0203A4EC
_0807A76C: .4byte gUnknown_0203A56C
...
DisplayWRankUpPopup: @ 0x0807A794
	...
	adds r6, r0, #0
	movs r4, #0
	ldr r5, _0807A7D0  @ gUnknown_0203A4EC
	adds r0, r5, #0
	...
	adds r4, r5, #0
_0807A7AA:
	ldr r5, _0807A7D4  @ gUnknown_0203A56C
	adds r0, r5, #0
	bl BattleUnit_ShouldDisplayWRankUp
	lsls r0, r0, #0x18
	cmp r0, #0
...
_0807A7CA:
	...
	bx r0
	.align 2, 0
_0807A7D0: .4byte gUnknown_0203A4EC
_0807A7D4: .4byte gUnknown_0203A56C
...
sub_807AD1C: @ 0x0807AD1C
	...
	movs r4, #0
	ldr r0, _0807AD50  @ gUnknown_03004E50
	ldr r0, [r0]
	ldr r0, [r0]
...
_0807AD50: .4byte gUnknown_03004E50
...
_0807AD58:
	...
	cmp r3, #2
	bgt _0807AD80
	ldr r0, _0807ADFC  @ gUnknown_03004E50
	ldr r0, [r0]
	ldr r2, [r0]
...
_0807ADB8:
	...
	orrs r4, r0
	strb r4, [r2, #3]
	ldr r1, _0807ADFC  @ gUnknown_03004E50
	ldr r0, [r1]
	movs r5, #0xb
	ldrsb r5, [r0, r5]
	movs r0, #0xc0
	...
	b _0807AE28
	.align 2, 0
_0807ADFC: .4byte gUnknown_03004E50
...
_0807AF02:
	...
	cmp r5, #0
	bne _0807AF48
	ldr r4, _0807AF90  @ gUnknown_0203A4EC
	mov r0, sp
	adds r1, r4, #0
	movs r2, #0x80
	bl memcpy
...
_0807AF58:
	...
	cmp r0, #3
	ble _0807AF58
	ldr r1, _0807AF98  @ gUnknown_03004E50
	ldr r0, [r1]
	ldrb r0, [r0, #8]
	strb r0, [r5, #8]
	movs r0, #0xff
...
_0807AF90: .4byte gUnknown_0203A4EC
_0807AF94: .4byte gUnknown_03001C38
_0807AF98: .4byte gUnknown_03004E50
_0807AF9C:
	cmp r0, #0xa
	bgt _0807AFA8
	adds r1, r5, #0
...
sub_807B054: @ 0x0807B054
	push {lr}
	ldr r0, _0807B06C  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0807B068:
	...
	bx r0
	.align 2, 0
_0807B06C: .4byte gUnknown_0202BCF0
...
_0807B0E4:
	...
	cmp r0, #0
	bne _0807B150
	ldr r0, _0807B19C  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xd]
	cmp r0, #0
	beq _0807B11E
...
_0807B11E:
	...
	adds r0, r0, r1
	ldrb r1, [r0]
	ldr r0, _0807B1A8  @ gUnknown_0203A4EC
	str r3, [sp, #0x70]
...
_0807B1A8: .4byte gUnknown_0203A4EC
_0807B1AC:
	movs r0, #1
	negs r0, r0
_0807B1B0:
...
sub_807B234: @ 0x0807B234
	push {lr}
	ldr r2, _0807B250  @ gUnknown_0203A4EC
	movs r1, #0x10
	ldrsb r1, [r2, r1]
	ldrb r2, [r2, #0x11]
	adds r2, #4
	...
	bx r0
	.align 2, 0
_0807B250: .4byte gUnknown_0203A4EC

	THUMB_FUNC_START sub_807B254
sub_807B254: @ 0x0807B254
	push {lr}
	ldr r2, _0807B270  @ gUnknown_0203A4EC
	ldrb r1, [r2, #0x10]
	adds r1, #4
	lsls r1, r1, #0x18
	asrs r1, r1, #0x18
	...
	bx r0
	.align 2, 0
_0807B270: .4byte gUnknown_0203A4EC

	THUMB_FUNC_START sub_807B274
sub_807B274: @ 0x0807B274
	push {lr}
	ldr r2, _0807B290  @ gUnknown_0203A4EC
	ldrb r1, [r2, #0x10]
	subs r1, #4
	lsls r1, r1, #0x18
	asrs r1, r1, #0x18
	...
	bx r0
	.align 2, 0
_0807B290: .4byte gUnknown_0203A4EC

	THUMB_FUNC_START sub_807B294
sub_807B294: @ 0x0807B294
	push {lr}
	ldr r2, _0807B2B0  @ gUnknown_0203A4EC
	movs r1, #0x10
	ldrsb r1, [r2, r1]
	ldrb r2, [r2, #0x11]
	subs r2, #4
	...
	bx r0
	.align 2, 0
_0807B2B0: .4byte gUnknown_0203A4EC
...
SetupBattleMOVEUNITs: @ 0x0807B464
	...
	cmp r0, #2
	bne _0807B4C0
	ldr r0, _0807B4CC  @ gUnknown_0203A5EC
	ldr r0, [r0]
	lsls r0, r0, #0xd
	lsrs r0, r0, #0xd
	movs r1, #0x80
...
_0807B4CC: .4byte gUnknown_0203A5EC
...
sub_807B4D0: @ 0x0807B4D0
	...
	cmp r0, #2
	bne _0807B502
	ldr r0, _0807B574  @ gUnknown_0203A5EC
	ldr r0, [r0]
	lsls r0, r0, #0xd
	lsrs r0, r0, #0xd
	movs r1, #0x80
...
_0807B574: .4byte gUnknown_0203A5EC
_0807B578:
	cmp r2, r1
	blt _0807B580
	movs r0, #1
...
sub_807B5DC: @ 0x0807B5DC
	push {r4, r5, lr}
	ldr r5, _0807B620  @ gUnknown_0203A4EC
	adds r2, r5, #0
	adds r2, #0x4a
	movs r1, #0
	movs r0, #0x6c
	...
	movs r0, #1
	strb r0, [r1]
	ldr r4, _0807B628  @ gUnknown_0203A5EC
	str r4, [r2, #0x50]
	bl MapAnim_AdvanceBattleRound
	ldr r1, _0807B62C  @ gUnknown_0203A56C
	adds r0, r5, #0
	adds r2, r4, #0
	...
	bx r0
	.align 2, 0
_0807B620: .4byte gUnknown_0203A4EC
_0807B624: .4byte gUnknown_0203E1F0
_0807B628: .4byte gUnknown_0203A5EC
_0807B62C: .4byte gUnknown_0203A56C
_0807B630: .4byte gUnknown_089A31F8

	THUMB_FUNC_START sub_807B634
sub_807B634: @ 0x0807B634
	push {r4, r5, lr}
	ldr r5, _0807B678  @ gUnknown_0203A4EC
	adds r2, r5, #0
	adds r2, #0x4a
	movs r1, #0
	movs r0, #0x6c
	...
	movs r0, #1
	strb r0, [r1]
	ldr r4, _0807B680  @ gUnknown_0203A5EC
	str r4, [r2, #0x50]
	bl MapAnim_AdvanceBattleRound
	ldr r1, _0807B684  @ gUnknown_0203A56C
	adds r0, r5, #0
	adds r2, r4, #0
	bl SetupMapBattleAnim
	...
	bx r0
	.align 2, 0
_0807B678: .4byte gUnknown_0203A4EC
_0807B67C: .4byte gUnknown_0203E1F0
_0807B680: .4byte gUnknown_0203A5EC
_0807B684: .4byte gUnknown_0203A56C
_0807B688: .4byte gUnknown_089A3238

	THUMB_FUNC_START sub_807B68C
sub_807B68C: @ 0x0807B68C
	push {r4, r5, lr}
	ldr r5, _0807B6D0  @ gUnknown_0203A4EC
	adds r2, r5, #0
	adds r2, #0x4a
	movs r1, #0
	movs r0, #0x6c
	...
	movs r0, #1
	strb r0, [r1]
	ldr r4, _0807B6D8  @ gUnknown_0203A5EC
	str r4, [r2, #0x50]
	bl MapAnim_AdvanceBattleRound
	ldr r1, _0807B6DC  @ gUnknown_0203A56C
	adds r0, r5, #0
	adds r2, r4, #0
	bl SetupMapBattleAnim
...
BeginMapAnimForSteal: @ 0x0807B6E4
	...
	adds r1, #1
	strb r3, [r1]
	ldr r1, _0807B734  @ gUnknown_0203A56C
	ldr r2, _0807B738  @ gUnknown_0203A5EC
	bl SetupMapBattleAnim
...
BeginMapAnimForSummon: @ 0x0807B740
	...
	adds r1, #1
	strb r2, [r1]
	ldr r1, _0807B78C  @ gUnknown_0203A56C
	ldr r2, _0807B790  @ gUnknown_0203A5EC
	bl SetupMapBattleAnim
...
BeginMapAnimForSummonDK: @ 0x0807B798
	...
	adds r1, #1
	strb r2, [r1]
	ldr r1, _0807B7E4  @ gUnknown_0203A56C
	ldr r2, _0807B7E8  @ gUnknown_0203A5EC
	bl SetupMapBattleAnim
	...
	bx r0
	.align 2, 0
_0807B7DC: .4byte gUnknown_0203A4EC
_0807B7E0: .4byte gUnknown_0203E1F0
_0807B7E4: .4byte gUnknown_0203A56C
_0807B7E8: .4byte gUnknown_0203A5EC
_0807B7EC: .4byte gUnknown_089A33C0

	THUMB_FUNC_START sub_807B7F0
sub_807B7F0: @ 0x0807B7F0
	push {r4, lr}
	ldr r0, _0807B840  @ gUnknown_0203A4EC
	adds r3, r0, #0
	adds r3, #0x4a
	movs r2, #0
	movs r1, #0x4f
	...
	adds r1, #1
	strb r2, [r1]
	ldr r1, _0807B848  @ gUnknown_0203A56C
	ldr r2, _0807B84C  @ gUnknown_0203A5EC
	bl SetupMapBattleAnim
	...
	bx r0
	.align 2, 0
_0807B840: .4byte gUnknown_0203A4EC
_0807B844: .4byte gUnknown_0203E1F0
_0807B848: .4byte gUnknown_0203A56C
_0807B84C: .4byte gUnknown_0203A5EC
_0807B850: .4byte gUnknown_089A34B0

	THUMB_FUNC_START BeginBattleMapAnims
BeginBattleMapAnims: @ 0x0807B854
	push {r4, r5, r6, lr}
	ldr r0, _0807B86C  @ gUnknown_0203A4D4
	ldrh r0, [r0]
	movs r1, #0x90
	lsls r1, r1, #2
	ands r1, r0
	...
	b _0807B8C8
	.align 2, 0
_0807B86C: .4byte gUnknown_0203A4D4
_0807B870:
	...
	adds r0, #0x62
	strb r1, [r0]
	ldr r4, _0807B8B0  @ gUnknown_0203A4EC
	ldr r5, _0807B8B4  @ gUnknown_0203A56C
	ldr r6, _0807B8B8  @ gUnknown_0203A5EC
	adds r0, r4, #0
	adds r1, r5, #0
	adds r2, r6, #0
...
_0807B8B0: .4byte gUnknown_0203A4EC
_0807B8B4: .4byte gUnknown_0203A56C
_0807B8B8: .4byte gUnknown_0203A5EC
...
SetupMapBattleAnim: @ 0x0807B900
	...
	cmp r0, #1
	bls _0807B930
	ldr r0, _0807B9AC  @ gUnknown_0203A56C
	bl HideUnitSMS
	movs r0, #1
	adds r1, r4, #0
	adds r2, r4, #0
	bl MakeBattleMOVEUNIT
_0807B930:
	ldr r0, _0807B9B0  @ gUnknown_0203A5EC
	ldr r0, [r0]
	lsls r0, r0, #0xd
	lsrs r0, r0, #0xd
	movs r1, #0x80
	...
	cmp r0, #0
	beq _0807B964
	ldr r4, _0807B9B4  @ gUnknown_0203A4D4
	ldr r2, [r4, #0x10]
	movs r0, #2
	adds r1, r5, #0
	bl MakeBattleMOVEUNIT
...
_0807B9AC: .4byte gUnknown_0203A56C
_0807B9B0: .4byte gUnknown_0203A5EC
_0807B9B4: .4byte gUnknown_0203A4D4
...
sub_807C0DC: @ 0x0807C0DC
	push {lr}
	ldr r0, _0807C0F4  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0807C0F0:
	...
	bx r0
	.align 2, 0
_0807C0F4: .4byte gUnknown_0202BCF0
...
sub_807C8FC: @ 0x0807C8FC
	push {r4, r5, r6, r7, lr}
	ldr r5, _0807C920  @ gUnknown_0203A5EC
	ldr r0, _0807C924  @ gUnknown_0203A4EC
	movs r1, #0
	bl sub_807C8A0
	ldr r0, _0807C928  @ gUnknown_0203A56C
	movs r1, #1
	bl sub_807C8A0
	bl ClearRounds
	movs r7, #0
	...
	b _0807C934
	.align 2, 0
_0807C920: .4byte gUnknown_0203A5EC
_0807C924: .4byte gUnknown_0203A4EC
_0807C928: .4byte gUnknown_0203A56C
...
sub_807DBE4: @ 0x0807DBE4
	...
	sub sp, #8
	adds r5, r0, #0
	ldr r0, _0807DC80  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0807DC60:
	...
	bx r0
	.align 2, 0
_0807DC80: .4byte gUnknown_0202BCF0
...
_0807F3CC:
	...
	cmp r6, #0
	bne _0807F448
	ldr r0, _0807F440  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0807F440: .4byte gUnknown_0202BCF0
_0807F444: .4byte 0x000002CD
_0807F448:
	ldr r0, _0807F474  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0807F468:
	...
	bx r0
	.align 2, 0
_0807F474: .4byte gUnknown_0202BCF0
...
_0807F4F2:
	...
	adds r1, r4, #0
	bl APProc_Create
	ldr r0, _0807F538  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
sub_80815EC: @ 0x080815EC
	...
	ldr r1, _08081618  @ gUnknown_0203A56C
	adds r3, r1, #0
	adds r3, #0x73
	ldrb r3, [r3]
	adds r4, r2, #0
...
_08081618: .4byte gUnknown_0203A56C
...
sub_8081B70: @ 0x08081B70
	push {lr}
	ldr r0, _08081BC0  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_08081B84:
	...
	ldr r1, _08081BC8  @ gUnknown_0203A56C
	adds r0, r1, #0
	adds r0, #0x73
	ldrb r2, [r0]
	adds r0, r3, #0
...
_08081BC8: .4byte gUnknown_0203A56C
...
sub_8081D84: @ 0x08081D84
	push {r4, lr}
	ldr r0, _08081DD4  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
