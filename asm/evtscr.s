...
_0800FBFA:
	...
	bl sub_800F914
	adds r5, r0, #0
	ldr r0, _0800FC48  @ gBmMapMagicSealed
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	ldrh r2, [r6, #0x3c]
...
_0800FC2E:
	...
	b _0800FC72
	.align 2, 0
_0800FC48: .4byte gBmMapMagicSealed
_0800FC4C:
	str r5, [r6, #0x48]
	adds r0, r6, #0
	adds r0, #0x4c
...
_0800FE7C:
	...
	lsls r0, r0, #0x10
	lsrs r4, r0, #0x10
	ldr r0, _0800FEBC  @ gBmMapMagicSealed
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	ldrh r0, [r7, #0x3c]
...
_0800FEBC: .4byte gBmMapMagicSealed
_0800FEC0:
	mov r0, r9
	lsls r1, r0, #0x18
	asrs r1, r1, #0x18
...
_0800FF36:
	...
	bl SMS_UpdateFromGameData
	bl RenderBmMap
	ldr r0, _0800FF5C  @ gBmMapMagicSealed
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	movs r0, #2
	b _0800FF62
	.align 2, 0
_0800FF5C: .4byte gBmMapMagicSealed
_0800FF60:
	movs r0, #3
_0800FF62:
	pop {r1}
