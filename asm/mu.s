...
_08078588:
	...
	cmp r7, #0
	beq _08078680
	ldr r4, _08078678  @ gUnknown_089A2C48
	adds r0, r4, #0
	bl Proc_Find
	cmp r0, #0
	beq _0807859E
...
_0807859E:
	...
	b _08078682
	.align 2, 0
_08078678: .4byte gUnknown_089A2C48
_0807867C: .4byte 0x06010000
_08078680:
	movs r0, #0
_08078682:
	add sp, #8
...
_080786E2:
	...
	THUMB_FUNC_START _MOVEUNIT6C_SetDefaultFacingDirection
_MOVEUNIT6C_SetDefaultFacingDirection: @ 0x080786E8
	push {lr}
	ldr r0, _080786FC  @ gUnknown_089A2C48
	bl Proc_Find
	cmp r0, #0
	beq _080786F8
...
_080786F8:
	...
	bx r0
	.align 2, 0
_080786FC: .4byte gUnknown_089A2C48

	THUMB_FUNC_START _MOVEUNIT6C_ChangeFutureMovement
_MOVEUNIT6C_ChangeFutureMovement: @ 0x08078700
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, _0807871C  @ gUnknown_089A2C48
	bl Proc_Find
	cmp r0, #0
	beq _08078714
	adds r1, r4, #0
...
_08078714:
	...
	bx r0
	.align 2, 0
_0807871C: .4byte gUnknown_089A2C48

	THUMB_FUNC_START DoesMoveunitExist
DoesMoveunitExist: @ 0x08078720
	push {lr}
	ldr r0, _08078734  @ gUnknown_089A2C48
	bl Proc_Find
	cmp r0, #0
	beq _0807872E
	movs r0, #1
_0807872E:
	...
	bx r1
	.align 2, 0
_08078734: .4byte gUnknown_089A2C48

	THUMB_FUNC_START IsThereAMovingMoveunit
IsThereAMovingMoveunit: @ 0x08078738
	push {lr}
	movs r3, #0
...
_0807876A:
	...
	THUMB_FUNC_START sub_8078770
sub_8078770: @ 0x08078770
	push {lr}
	adds r1, r0, #0
	ldr r0, [r1, #0x34]
	ldrb r0, [r0]
...
_0807878C:
	...
	THUMB_FUNC_START MOVEUNIT6C_ChangeFutureMovement
MOVEUNIT6C_ChangeFutureMovement: @ 0x08078790
	push {r4, lr}
	adds r3, r0, #0
	adds r4, r1, #0
	movs r2, #0
_08078798:
	...
	strb r0, [r1]
	adds r0, r3, #0
	bl __MOVEUNIT6C_PlaySoundStepByClass
	pop {r4}
	pop {r0}
	bx r0
...
_080787F2:
	...
	THUMB_FUNC_START Init6C_89A2938
Init6C_89A2938: @ 0x080787FC
	movs r2, #0
	str r2, [r0, #0x58]
	adds r1, r0, #0
	adds r1, #0x64
	...
	THUMB_FUNC_START Call89A2938_PlaySound1
Call89A2938_PlaySound1: @ 0x08078810
	push {lr}
	ldr r2, [r0, #0x58]
	adds r0, #0x64
	movs r3, #0
	...
	THUMB_FUNC_START Call89A2938_PlaySound2
Call89A2938_PlaySound2: @ 0x08078824
	push {lr}
	ldr r2, [r0, #0x5c]
	cmp r2, #0
	beq _08078838
...
_08078838:
	...
	THUMB_FUNC_START NewSoundStepPlay6C
NewSoundStepPlay6C: @ 0x0807883C
	push {r4, r5, r6, r7, lr}
	adds r5, r0, #0
	adds r7, r1, #0
	adds r6, r2, #0
	ldr r4, _0807886C  @ gUnknown_089A2938
	adds r0, r4, #0
	bl Proc_Find
	adds r2, r0, #0
	cmp r2, #0
...
_0807885C:
	...
	b _0807887E
	.align 2, 0
_0807886C: .4byte gUnknown_089A2938
_08078870:
	ldr r0, [r2, #0x60]
	cmp r0, #0
	bne _08078880
...
_08078880:
	...
	THUMB_FUNC_START __MOVEUNIT6C_PlaySoundStepByClass
__MOVEUNIT6C_PlaySoundStepByClass: @ 0x08078888
	push {lr}
