	...
	/* Seems something related special intro anim, and something related to promotion scrren & opinfo */

	THUMB_FUNC_START BanimPrepareSpecificScript
BanimPrepareSpecificScript: @ 0x0805A07C
	push {r4, r5, r6, r7, lr}
	adds r4, r0, #0
	adds r6, r1, #0
	bl sub_805A154
	cmp r0, #0
	bne _0805A09C
	ldr r0, _0805A098  @ gBanimSpecificScrConfigs
	lsls r1, r6, #2
	adds r2, r1, r0
	ldrb r5, [r2]
	adds r1, #1
	...
	b _0805A0AA
	.align 2, 0
_0805A098: .4byte gBanimSpecificScrConfigs
_0805A09C:
	ldr r2, _0805A0C8  @ gBanimSpecificScrConfigs
	lsls r1, r6, #2
	adds r0, r1, #2
	adds r0, r0, r2
	ldrb r5, [r0]
...
_0805A0AA:
	...
	b _0805A0E0
	.align 2, 0
_0805A0C8: .4byte gBanimSpecificScrConfigs
...
_0805A150: .4byte gBanimOaml
	...
	THUMB_FUNC_END BanimPrepareSpecificScript
...
sub_805A5A8: @ 0x0805A5A8
	...
	cmp r0, #0
	bne _0805A5FA
	ldr r0, _0805A604  @ gBanimSpecificScrConfigs
	ldrb r1, [r0, #0x18]
	movs r2, #6
	ldrsh r0, [r5, r2]
	lsls r0, r0, #5
...
_0805A604: .4byte gBanimSpecificScrConfigs
...
sub_805A60C: @ 0x0805A60C
	...
	mov r9, r0
	ldr r2, _0805A698  @ gBanimSpecificScrConfigs
	ldrh r1, [r4, #0xa]
	lsls r1, r1, #2
	adds r0, r1, r2
	ldrb r5, [r0]
...
_0805A698: .4byte gBanimSpecificScrConfigs
...
sub_805A7B4: @ 0x0805A7B4
	...
	mov sl, r0
	ldr r2, _0805A830  @ gBanimSpecificScrConfigs
	ldrh r0, [r7, #0xa]
	lsls r0, r0, #2
	adds r1, r0, r2
	ldrb r4, [r1]
...
_0805A830: .4byte gBanimSpecificScrConfigs
