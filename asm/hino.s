...
sub_80133A0: @ 0x080133A0
	...
	movs r6, #0
	adds r5, r7, #0
	ldr r4, _080133C0  @ gUnknown_020228A8
_080133AC:
	ldrh r1, [r4]
	movs r0, #0x1f
	ands r0, r1
...
_080133C0: .4byte gUnknown_020228A8
_080133C4:
...
ArchiveCurrentPalettes: @ 0x080134D4
	push {r4, r5, lr}
	bl GetPaletteBufferBuffer
	ldr r3, _0801351C  @ gUnknown_020228A8
	movs r1, #0
_080134DE:
	adds r5, r0, #0
	adds r5, #0x30
...
_080134E8:
	...
	bx r0
	.align 2, 0
_0801351C: .4byte gUnknown_020228A8
...
ArchivePalette: @ 0x08013520
	...
	bl GetPaletteBufferBuffer
	lsls r2, r4, #5
	ldr r1, _0801354C  @ gUnknown_020228A8
	adds r2, r2, r1
	lsls r1, r4, #1
	adds r1, r1, r4
	lsls r1, r1, #4
...
_08013538:
	...
	bx r0
	.align 2, 0
_0801354C: .4byte gUnknown_020228A8
...
_0801358A:
	...
	add r3, r9
	lsls r0, r5, #5
	ldr r1, _080135D0  @ gUnknown_020228A8
	adds r2, r0, r1
_080135A4:
	ldrh r0, [r3]
	adds r1, r6, #0
...
_080135D0: .4byte gUnknown_020228A8
_080135D4:
	movs r5, #0
	mov ip, r5
_080135D8:
	...
	add r3, r9
	lsls r0, r5, #5
	ldr r1, _08013670  @ gUnknown_020228A8
	adds r2, r0, r1
_080135F2:
	ldrh r1, [r3]
	adds r0, r6, #0
...
_08013664:
	...
	b _080136C0
	.align 2, 0
_08013670: .4byte gUnknown_020228A8
...
_0801367C:
	...
	adds r3, r7, r0
	lsls r0, r5, #5
	ldr r1, _08013720  @ gUnknown_020228A8
	adds r2, r0, r1
_08013698:
	ldrh r1, [r3]
	adds r0, r6, #0
...
_080136D2:
	...
	adds r3, r0, r1
	lsls r0, r5, #5
	ldr r5, _08013720  @ gUnknown_020228A8
	adds r2, r0, r5
_080136F6:
	ldrh r1, [r3]
	adds r0, r6, #0
...
_08013718:
	...
	b _08013772
	.align 2, 0
_08013720: .4byte gUnknown_020228A8
...
_0801372A:
	...
	adds r3, r0, r1
	lsls r0, r5, #5
	ldr r5, _08013788  @ gUnknown_020228A8
	adds r2, r0, r5
_0801374E:
	ldrh r1, [r3]
	adds r0, r6, #0
...
_08013772:
	...
	bx r0
	.align 2, 0
_08013788: .4byte gUnknown_020228A8
...
sub_8013928: @ 0x08013928
	...
	mov r8, r0
	lsls r5, r5, #5
	ldr r0, _08013984  @ gUnknown_020228A8
	adds r5, r5, r0
	adds r0, r5, #0
	adds r1, r4, #0
	movs r2, #0x10
...
_08013984: .4byte gUnknown_020228A8
...
sub_8013A84: @ 0x08013A84
	...
	lsls r1, r1, #5
	ldr r2, _08013AA0  @ gUnknown_020228A8
	adds r1, r1, r2
	movs r2, #0x10
	bl CpuSet
	pop {r0}
...
_08013AA0: .4byte gUnknown_020228A8
...
sub_8013AA4: @ 0x08013AA4
	...
	lsls r1, r1, #5
	ldr r2, _08013AC0  @ gUnknown_020228A8
	adds r1, r1, r2
	movs r2, #0x10
	bl CpuSet
	pop {r0}
...
_08013AC0: .4byte gUnknown_020228A8
...
_08014148:
	bl sub_80D74B0
	ldr r1, _08014168  @ gUnknown_020228A8
	movs r0, #0
	strh r0, [r1]
	bl EnablePaletteSync
	ldr r1, [r4, #0x5c]
...
_08014160:
	...
	bx r1
	.align 2, 0
_08014168: .4byte gUnknown_020228A8
...
sub_80141B0: @ 0x080141B0
	...
	movs r0, #1
	bl sub_8001F48
	ldr r1, _08014204  @ gUnknown_020228A8
	movs r0, #0
	strh r0, [r1]
	bl EnablePaletteSync
	...
	bx r0
	.align 2, 0
_08014204: .4byte gUnknown_020228A8
...
_08014A2E:
	...
	adds r0, r0, r1
	lsls r0, r0, #1
	ldr r1, _08014A3C  @ gUnknown_02022CA8
	adds r0, r0, r1
	b _08014A72
	.align 2, 0
_08014A3C: .4byte gUnknown_02022CA8
_08014A40:
	lsls r0, r2, #5
	adds r0, r0, r1
	lsls r0, r0, #1
	ldr r1, _08014A4C  @ gUnknown_020234A8
	adds r0, r0, r1
	b _08014A72
	.align 2, 0
_08014A4C: .4byte gUnknown_020234A8
_08014A50:
	lsls r0, r2, #5
	adds r0, r0, r1
	lsls r0, r0, #1
	ldr r1, _08014A5C  @ gUnknown_02023CA8
	adds r0, r0, r1
	b _08014A72
	.align 2, 0
_08014A5C: .4byte gUnknown_02023CA8
_08014A60:
	lsls r0, r2, #5
	adds r0, r0, r1
	lsls r0, r0, #1
	ldr r1, _08014A6C  @ gUnknown_020244A8
	adds r0, r0, r1
	b _08014A72
	.align 2, 0
_08014A6C: .4byte gUnknown_020244A8
_08014A70:
	movs r0, #0
_08014A72:
	pop {r1}
...
sub_8014BE0: @ 0x08014BE0
	push {r4, r5, r6, r7, lr}
	lsls r0, r0, #5
	ldr r1, _08014C34  @ gUnknown_020228A8
	movs r2, #0x1f
	mov ip, r2
	movs r7, #0xf8
	lsls r7, r7, #2
...
_08014BF6:
	...
	bx r0
	.align 2, 0
_08014C34: .4byte gUnknown_020228A8
...
sub_8014C54: @ 0x08014C54
	...
	add r5, r9
	lsls r5, r5, #1
	ldr r0, _08014CA0  @ gUnknown_02022CA8
	adds r5, r5, r0
	adds r0, r6, #0
	adds r1, r5, #0
	bl Text_Draw
	...
	bx r0
	.align 2, 0
_08014CA0: .4byte gUnknown_02022CA8
