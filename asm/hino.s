...
sub_8012F20: @ 0x08012F20
	...
	adds r4, r0, #0
	adds r5, r1, #0
	ldr r6, _08012F4C  @ gGenericBuffer
	adds r1, r6, #0
	bl LZ77UnCompWram
	adds r0, r4, #0
	bl FilterR0ForRawCopy
...
_08012F3A:
	...
	bx r0
	.align 2, 0
_08012F4C: .4byte gGenericBuffer
...
_08013290:
	...
	ldr r4, [sp]
	lsls r0, r4, #2
	ldr r7, _0801339C  @ gGenericBuffer
	adds r0, r0, r7
	mov sl, r0
	str r0, [sp, #8]
	negs r1, r2
...
_08013328:
	...
	mov r7, ip
	lsls r0, r7, #2
	ldr r3, _0801339C  @ gGenericBuffer
	adds r0, r0, r3
	mov r4, sp
	ldrh r4, [r4, #4]
	strh r4, [r0]
...
_08013370:
	...
	bge _080132BC
_08013388:
	ldr r0, _0801339C  @ gGenericBuffer
	add sp, #0x1c
	pop {r3, r4, r5}
	mov r8, r3
	mov r9, r4
...
sub_80133A0: @ 0x080133A0
	push {r4, r5, r6, r7, lr}
	adds r3, r0, #0
	ldr r7, _080133BC  @ gGenericBuffer
	movs r6, #0
	adds r5, r7, #0
...
_080133AC:
	...
	b _080133C8
	.align 2, 0
_080133BC: .4byte gGenericBuffer
