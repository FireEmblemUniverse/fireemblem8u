...
sub_8083018: @ 0x08083018
	push {lr}
	ldr r0, _08083038  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xf]
	cmp r0, #0x80
	bne _0808303C
	movs r0, #0
	...
	b _0808303E
	.align 2, 0
_08083038: .4byte gUnknown_0202BCF0
_0808303C:
	movs r0, #0
_0808303E:
	pop {r1}
...
sub_8083044: @ 0x08083044
	push {lr}
	ldr r0, _08083088  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xf]
	cmp r0, #0x80
	bne _08083084
	movs r0, #0
...
_08083084:
	...
	b _0808308E
	.align 2, 0
_08083088: .4byte gUnknown_0202BCF0
_0808308C:
	movs r0, #1
_0808308E:
	pop {r1}
...
sub_80830AC: @ 0x080830AC
	push {lr}
	ldr r0, _080830C8  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xf]
	cmp r0, #0x80
	bne _080830CC
	movs r0, #0x11
	...
	b _080830CE
	.align 2, 0
_080830C8: .4byte gUnknown_0202BCF0
_080830CC:
	movs r0, #0
_080830CE:
	pop {r1}
...
sub_80830D4: @ 0x080830D4
	push {lr}
	ldr r0, _080830F0  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xf]
	cmp r0, #0x80
	bne _080830F4
	movs r0, #0
	...
	b _080830F6
	.align 2, 0
_080830F0: .4byte gUnknown_0202BCF0
_080830F4:
	movs r0, #0
_080830F6:
	pop {r1}
...
sub_80830FC: @ 0x080830FC
	push {lr}
	ldr r0, _08083118  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xf]
	cmp r0, #0x80
	bne _0808311C
	movs r0, #0
	...
	b _0808311E
	.align 2, 0
_08083118: .4byte gUnknown_0202BCF0
_0808311C:
	movs r0, #0
_0808311E:
	pop {r1}
...
sub_8083124: @ 0x08083124
	push {lr}
	ldr r0, _08083140  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xf]
	cmp r0, #0x80
	bne _08083144
	movs r0, #0x15
	...
	b _08083146
	.align 2, 0
_08083140: .4byte gUnknown_0202BCF0
_08083144:
	movs r0, #0
_08083146:
	pop {r1}
...
sub_8083280: @ 0x08083280
	push {r4, lr}
	ldr r0, _080832A4  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	...
	b _080832B0
	.align 2, 0
_080832A4: .4byte gUnknown_0202BCF0
_080832A8:
...
GetCurrentChapterBallistaePtr: @ 0x08083308
	push {lr}
	ldr r0, _0808331C  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
...
GetCurrentChapterBallistae2Ptr: @ 0x08083320
	...
	b _08083342
	.align 2, 0
_0808333C: .4byte gUnknown_0202BCF0
_08083340:
	ldr r0, [r2, #0x24]
_08083342:
	pop {r4}
...
GetChapterAllyUnitDataPointer: @ 0x08083348
	push {r4, r5, lr}
	ldr r5, _08083370  @ gUnknown_0202BCF0
	movs r0, #0xe
	ldrsb r0, [r5, r0]
	bl GetChapterEventDataPointer
	adds r4, r0, #0
	...
	b _080833A8
	.align 2, 0
_08083370: .4byte gUnknown_0202BCF0
_08083374:
	ldr r0, [r4, #0x28]
	b _080833A8
_08083378:
...
sub_80833B0: @ 0x080833B0
	push {lr}
	ldr r0, _080833E0  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
	...
	b _080833F8
	.align 2, 0
_080833E0: .4byte gUnknown_0202BCF0
...
sub_8083424: @ 0x08083424
	push {lr}
	ldr r0, _0808345C  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
	...
	b _08083462
	.align 2, 0
_0808345C: .4byte gUnknown_0202BCF0
_08083460:
	movs r0, #0
_08083462:
	pop {r1}
...
_08083472:
	...
	cmp r0, #0x4f
	beq _08083498
	ldr r0, _0808349C  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	ldrb r1, [r4, #1]
...
_08083498:
	...
	b _080834AA
	.align 2, 0
_0808349C: .4byte gUnknown_0202BCF0
_080834A0:
	adds r4, #0xc
_080834A2:
	ldrb r0, [r4]
...
sub_8083570: @ 0x08083570
	...
	cmp r0, #0
	beq _08083598
	ldr r0, _080835A4  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
...
_0808359E:
	...
	bx r0
	.align 2, 0
_080835A4: .4byte gUnknown_0202BCF0
...
sub_80835DC: @ 0x080835DC
	...
	ldr r0, _08083610  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r1, [r0]
	movs r2, #1
	orrs r1, r2
...
sub_80837B0: @ 0x080837B0
	...
	movs r1, #0
	bl Sound_PlaySong80024D4
	ldr r0, _080837D4  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r1, [r0]
	movs r2, #1
	orrs r1, r2
	...
	bx r0
	.align 2, 0
_080837D4: .4byte gUnknown_0202BCF0

	THUMB_FUNC_START sub_80837D8
sub_80837D8: @ 0x080837D8
	push {lr}
	ldr r0, _080837EC  @ gUnknown_0202BCF0
	ldrb r1, [r0, #0x14]
	movs r0, #0x40
	ands r0, r1
	cmp r0, #0
	...
	b _080837F2
	.align 2, 0
_080837EC: .4byte gUnknown_0202BCF0
_080837F0:
	movs r0, #1
_080837F2:
	pop {r1}
...
sub_80837F8: @ 0x080837F8
	push {lr}
	movs r3, #0
	ldr r2, _0808382C  @ gUnknown_0202BCF0
	ldrb r1, [r2, #0x14]
	movs r0, #0x40
	ands r0, r1
	cmp r0, #0
...
_08083824:
	...
	bx r1
	.align 2, 0
_0808382C: .4byte gUnknown_0202BCF0
...
_0808387E:
	ldr r5, _080838A0  @ gUnknown_0202BCF0
	ldrh r1, [r5, #0x10]
	cmp r4, r1
	bgt _080838A4
	cmp r1, r0
...
_080838A0: .4byte gUnknown_0202BCF0
_080838A4:
	movs r0, #0
_080838A6:
	pop {r4, r5, r6}
...
sub_8083DD8: @ 0x08083DD8
	...
	lsrs r6, r1, #0x18
	movs r4, #0
	ldr r5, _08083E18  @ gUnknown_0202BCF0
	movs r0, #0xe
	ldrsb r0, [r5, r0]
	bl GetChapterEventDataPointer
	ldr r1, [r0, #0x1c]
...
_08083DFE:
	...
	b _08083E2C
	.align 2, 0
_08083E18: .4byte gUnknown_0202BCF0
_08083E1C:
	adds r0, r4, #1
	lsls r0, r0, #0x10
	lsrs r4, r0, #0x10
...
sub_8083E34: @ 0x08083E34
	...
	lsls r0, r0, #0x18
	lsrs r2, r0, #0x18
	ldr r1, _08083E58  @ gUnknown_0202BCF0
	adds r0, r1, #0
	adds r0, #0x4b
	ldrb r0, [r0]
	cmp r0, #0
	...
	b _08083E5E
	.align 2, 0
_08083E58: .4byte gUnknown_0202BCF0
_08083E5C:
	movs r0, #0
_08083E5E:
	pop {r1}
...
TryCallSelectEvents_u1C: @ 0x08083E64
	...
	lsls r0, r0, #0x18
	lsrs r2, r0, #0x18
	ldr r1, _08083EAC  @ gUnknown_0202BCF0
	adds r6, r1, #0
	adds r6, #0x4b
	ldrb r0, [r6]
	cmp r0, #0
	...
	b _08083EB2
	.align 2, 0
_08083EAC: .4byte gUnknown_0202BCF0
_08083EB0:
	movs r0, #0
_08083EB2:
	pop {r4, r5, r6}
...
sub_8083EB8: @ 0x08083EB8
	...
	b _08083F60
_08083EC8:
	ldr r0, _08083EEC  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	lsls r0, r0, #0x10
	...
	b _08083EF2
	.align 2, 0
_08083EEC: .4byte gUnknown_0202BCF0
_08083EF0:
	movs r0, #1
_08083EF2:
	cmp r0, #1
...
_08083F18:
	...
	lsls r0, r0, #0x18
	lsrs r4, r0, #0x18
	ldr r0, _08083F58  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
...
_08083F40:
	...
	b _08083F60
	.align 2, 0
_08083F58: .4byte gUnknown_0202BCF0
_08083F5C:
	lsls r0, r4, #0x18
	asrs r0, r0, #0x18
_08083F60:
...
sub_8083F68: @ 0x08083F68
	...
	cmp r0, #2
	beq _08083F9A
	ldr r0, _08083FA0  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
...
_08083F9A:
	...
	b _08083FA6
	.align 2, 0
_08083FA0: .4byte gUnknown_0202BCF0
_08083FA4:
	movs r0, #1
_08083FA6:
	add sp, #0x1c
...
sub_8083FB0: @ 0x08083FB0
	...
	cmp r0, #2
	beq _08083FEE
	ldr r0, _08083FF8  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
...
_08083FEE:
	...
	bx r0
	.align 2, 0
_08083FF8: .4byte gUnknown_0202BCF0
...
GetAvailableLocaCommandAt: @ 0x08084078
	...
	lsls r5, r5, #0x18
	lsrs r5, r5, #0x18
	ldr r0, _080840B4  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
	...
	b _080840BA
	.align 2, 0
_080840B4: .4byte gUnknown_0202BCF0
_080840B8:
	movs r0, #0
_080840BA:
	add sp, #0x1c
...
sub_80840C4: @ 0x080840C4
	...
	lsls r1, r1, #0x18
	lsrs r4, r1, #0x18
	ldr r0, _08084104  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
...
_080840F8:
	...
	mov pc, r0
	.align 2, 0
_08084104: .4byte gUnknown_0202BCF0
...
_08084374:
	...
	lsls r0, r0, #0x18
	lsrs r4, r0, #0x18
	ldr r0, _080843AC  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
...
_08084402:
	...
	movs r0, #1
	bl TryCallSelectEvents_u1C
	ldr r0, _08084454  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
...
_0808446C:
	...
	lsls r0, r0, #0x18
	lsrs r4, r0, #0x18
	ldr r0, _0808448C  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
	...
	b _0808449A
	.align 2, 0
_0808448C: .4byte gUnknown_0202BCF0
_08084490:
	mov r0, sp
	movs r1, #1
	bl CallEventsFromBuffer
...
_080844C0:
	...
	lsls r0, r0, #0x18
	lsrs r4, r0, #0x18
	ldr r0, _080844EC  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
	...
	b _080844FE
	.align 2, 0
_080844EC: .4byte gUnknown_0202BCF0
_080844F0:
	bl sub_80845A4
	mov r0, sp
	movs r1, #1
...
_08084518:
	...
	lsls r0, r0, #0x18
	lsrs r4, r0, #0x18
	ldr r0, _08084544  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetChapterEventDataPointer
	...
	b _08084556
	.align 2, 0
_08084544: .4byte gUnknown_0202BCF0
_08084548:
	bl sub_80845A4
	mov r0, sp
	movs r1, #1
...
_08084662:
	...
	beq _08084686
	adds r1, r0, #0
	ldr r0, _080846B4  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xe]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r1, r0
...
_080846B4: .4byte gUnknown_0202BCF0
_080846B8:
	ldrh r0, [r4, #2]
	cmp r0, #0
	beq _080846D4
...
sub_80846E4: @ 0x080846E4
	...
	cmp r0, r1
	beq _08084740
	ldr r5, _08084734  @ gUnknown_0202BCF0
	adds r7, r1, #0
_080846F8:
	ldrb r0, [r4, #2]
	cmp r0, #0xff
...
_08084734: .4byte gUnknown_0202BCF0
_08084738:
	adds r4, #0xc
	ldrh r0, [r4]
	cmp r0, r7
...
IsCharacterForceDeployed_: @ 0x08084800
	...
	cmp r0, r1
	beq _08084850
	ldr r3, _08084844  @ gUnknown_0202BCF0
	adds r5, r1, #0
_08084814:
	ldrb r0, [r2, #2]
	cmp r0, #0xff
...
_08084844: .4byte gUnknown_0202BCF0
_08084848:
	adds r2, #4
	ldrh r0, [r2]
	cmp r0, r5
