...
sub_8041D8C: @ 0x08041D8C
	...
	ldr r0, [r0]
	str r0, [r1]
	ldr r0, _08041DC0  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
sub_804320C: @ 0x0804320C
	...
	movs r2, #8
	bl memcpy
	ldr r0, _08043240  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_08043C9E:
	...
	cmp r0, #0
	beq _08043CD8
	ldr r0, _08043CF0  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0804411A:
	...
	cmp r0, #0
	beq _08044156
	ldr r0, _080441C8  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_080441C8: .4byte gUnknown_0202BCF0
...
_080458FC:
	...
	bl Sound_PlaySong80024E4
_08045906:
	ldr r0, _0804591C  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
sub_80463A8: @ 0x080463A8
	...
	ldrb r0, [r4]
	str r0, [r7, #0x38]
	ldr r0, _0804642C  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0804642C: .4byte gUnknown_0202BCF0
...
sub_804645C: @ 0x0804645C
	push {lr}
	ldr r0, _08046474  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
sub_8046580: @ 0x08046580
	...
	cmp r0, #0
	bne _080465B0
	ldr r0, _080466EC  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_080466DA:
	...
	bx r0
	.align 2, 0
_080466EC: .4byte gUnknown_0202BCF0
...
sub_8046704: @ 0x08046704
	...
	cmp r0, #0
	bne _08046724
	ldr r0, _08046798  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_08046790:
	...
	bx r0
	.align 2, 0
_08046798: .4byte gUnknown_0202BCF0
...
sub_8046D6C: @ 0x08046D6C
	...
	ldr r0, [r4, #0x48]
	bl LoadGame
	ldr r1, _08046DAC  @ gUnknown_0202BCF0
	ldrb r2, [r1, #0x14]
	movs r0, #0xdf
	ands r0, r2
	strb r0, [r1, #0x14]
...
_08048254: .4byte gUnknown_0202BCF0
...
sub_8048280: @ 0x08048280
	...
	strb r0, [r1, #3]
	strb r0, [r1, #1]
	ldr r1, _080482D8  @ gUnknown_0202BCF0
	adds r1, #0x41
	ldrb r2, [r1]
	subs r0, #0xd
	ands r0, r2
...
sub_8048524: @ 0x08048524
	...
	cmp r1, r0
	bcs _0804857C
	ldr r0, _08048584  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0804857C:
	...
	bx r0
	.align 2, 0
_08048584: .4byte gUnknown_0202BCF0
...
sub_8048594: @ 0x08048594
	...
	cmp r1, r0
	bcs _080485EC
	ldr r0, _080485F4  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_080485EC:
	...
	bx r0
	.align 2, 0
_080485F4: .4byte gUnknown_0202BCF0
...
sub_804867C: @ 0x0804867C
	...
	b _080486BE
_0804868C:
	ldr r0, _080486C4  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_080486BE:
	...
	bx r1
	.align 2, 0
_080486C4: .4byte gUnknown_0202BCF0
...
sub_8048DD0: @ 0x08048DD0
	...
	cmp r1, r0
	bne _08048E2E
	ldr r0, _08048E64  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
sub_80497CC: @ 0x080497CC
	push {r4, r5, lr}
	ldr r1, _08049824  @ gUnknown_0202BCF0
	movs r0, #0x42
	adds r0, r0, r1
	mov ip, r0
	ldrb r0, [r0]
...
_0804997C:
	ldr r0, _08049988  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xf]
	cmp r0, #0
	beq _080499A2
	...
	b _080499A4
	.align 2, 0
_08049988: .4byte gUnknown_0202BCF0
_0804998C: .4byte gUnknown_085AA5BC
_08049990:
	ldr r0, _080499AC  @ gUnknown_0202BCF0
	ldrb r1, [r0, #0xf]
...
_08049A14:
	ldr r0, _08049A1C  @ gUnknown_0202BCF0
	strb r2, [r0, #0xf]
	ldr r2, _08049A20  @ gUnknown_03001818
	b _08049A26
	.align 2, 0
_08049A1C: .4byte gUnknown_0202BCF0
...
sub_8049D24: @ 0x08049D24
	...
	cmp r5, #1
	bne _08049E30
	ldr r0, _08049E28  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_08049E30:
	ldr r0, _08049E70  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_08049E7C:
	...
	beq _08049EAC
	bl sub_8048A94
	ldr r0, _08049EA8  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_08049EE2:
	...
	cmp sl, r0
	beq _08049F12
	ldr r0, _08049F34  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_08049FB0:
	...
	cmp r0, #0
	beq _0804A040
	ldr r0, _0804A03C  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0804A040:
	...
	cmp r0, #0
	beq _0804A0A8
	ldr r0, _0804A0A0  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0804A0D4:
	...
	cmp r2, r0
	beq _0804A0F0
	ldr r0, _0804A104  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
sub_804A3A8: @ 0x0804A3A8
	...
	cmp r0, #0
	beq _0804A400
	ldr r0, _0804A3FC  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0804A3FC: .4byte gUnknown_0202BCF0
_0804A400:
	movs r0, #2
	ands r0, r1
	cmp r0, #0
	beq _0804A426
	ldr r0, _0804A42C  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
sub_804A6A4: @ 0x0804A6A4
	...
	adds r2, #0x30
	adds r3, r0, r2
	ldr r1, _0804A798  @ gUnknown_0203A4EC
	mov r9, r1
	adds r1, #0x6e
	ldrb r1, [r1]
	lsls r1, r1, #0x18
	...
	lsls r0, r0, #3
	adds r2, r0, r2
	ldr r4, _0804A79C  @ gUnknown_0203A56C
	adds r1, r4, #0
	adds r1, #0x6e
	ldrb r1, [r1]
	lsls r1, r1, #0x18
...
_0804A798: .4byte gUnknown_0203A4EC
_0804A79C: .4byte gUnknown_0203A56C
_0804A7A0:
...
sub_804AE7C: @ 0x0804AE7C
	...
	bl sub_8048A94
	str r4, [r5, #0x58]
	ldr r0, _0804AEB8  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
_0804AEB8: .4byte gUnknown_0202BCF0
_0804AEBC:
	movs r0, #0
_0804AEBE:
	pop {r4, r5}
...
_0804AEDC:
	...
	cmp r0, #0
	beq _0804AF10
	ldr r0, _0804AF28  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xf]
	cmp r0, r4
	beq _0804AF10
	lsls r0, r4, #6
...
_0804AF88:
	...
	movs r1, #0xe
	strb r1, [r0]
	ldr r0, _0804B0CC  @ gUnknown_0202BCF0
	ldrb r0, [r0, #0xf]
	lsls r0, r0, #6
	str r0, [sp, #0x14]
	adds r4, r0, #0
...
_0804B498:
	...
	adds r0, #0xf
	adds r1, r1, r0
	ldr r3, _0804B500  @ gUnknown_0202BCF0
	ldrb r0, [r3, #0xf]
	strb r0, [r1]
	ldrb r0, [r2, #0xe]
	adds r0, #1
...
_0804B500: .4byte gUnknown_0202BCF0
_0804B504:
	ldrb r0, [r3, #0xf]
	bl sub_80492E8
	adds r0, r5, #0
...
sub_804B554: @ 0x0804B554
	...
	adds r0, #0xf
	adds r1, r1, r0
	ldr r3, _0804B5C8  @ gUnknown_0202BCF0
	ldrb r0, [r3, #0xf]
	strb r0, [r1]
	ldrb r0, [r2, #0xe]
	adds r0, #1
...
_0804B5C8: .4byte gUnknown_0202BCF0
_0804B5CC:
	ldrb r0, [r3, #0xf]
	bl sub_80492E8
	adds r0, r6, #0
...
sub_804B604: @ 0x0804B604
	movs r3, #0
	str r3, [r0, #0x58]
	ldr r2, _0804B61C  @ gUnknown_0202BCF0
	ldrb r1, [r2, #0xf]
	lsls r1, r1, #6
	str r1, [r0, #0x5c]
...
sub_804B850: @ 0x0804B850
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
	ldr r6, _0804B8C0  @ gUnknown_0203A4EC
	movs r0, #0x13
	ldrsb r0, [r6, r0]
	cmp r0, #0
	bne _0804B86C
	...
	str r4, [r7, #0x54]
_0804B86C:
	ldr r5, _0804B8C8  @ gUnknown_0203A56C
	movs r0, #0x13
	ldrsb r0, [r5, r0]
	cmp r0, #0
	bne _0804B8B8
...
sub_804B8D0: @ 0x0804B8D0
	push {r4, r5, lr}
	ldr r0, _0804B918  @ gUnknown_0203A4EC
	ldrb r0, [r0, #0xb]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	bl GetUnit
...
_0804B912:
	...
	bx r0
	.align 2, 0
_0804B918: .4byte gUnknown_0203A4EC
_0804B91C: .4byte gUnknown_0203A56C
...
sub_804BF4C: @ 0x0804BF4C
	...
	movs r0, #0xd
	strh r0, [r1, #0x1e]
	ldr r0, _0804BFA8  @ gUnknown_0202BCF0
	adds r0, #0x41
	ldrb r0, [r0]
	lsls r0, r0, #0x1e
	cmp r0, #0
...
sub_804D2A4: @ 0x0804D2A4
	...
	bl CopyDataWithPossibleUncomp
	ldr r5, _0804D36C  @ gUnknown_0202BCF0
	ldrb r0, [r5, #0xf]
	lsls r0, r0, #2
	add r0, sp
	ldr r0, [r0]
...
_0804D36C: .4byte gUnknown_0202BCF0
...
sub_804D37C: @ 0x0804D37C
	push {r4, lr}
	ldr r1, _0804D3D0  @ gUnknown_0202BCF0
	...
	bx r0
	.align 2, 0
_0804D3D0: .4byte gUnknown_0202BCF0
