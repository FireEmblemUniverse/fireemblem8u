	...
	THUMB_FUNC_START StartMapAnimLevelUp
StartMapAnimLevelUp: @ 0x0807F10C
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, _0807F120  @ sProcScr_MapAnimLevelUp
	...
	bx r0
	.align 2, 0
_0807F120: .4byte sProcScr_MapAnimLevelUp

	THUMB_FUNC_END StartMapAnimLevelUp

	THUMB_FUNC_START MapAnimLevelUp_InitLcd
MapAnimLevelUp_InitLcd: @ 0x0807F124
	push {r4, r5, lr}
...
_0807F18C: .4byte gLCDControlBuffer
	...
	THUMB_FUNC_END MapAnimLevelUp_InitLcd

	THUMB_FUNC_START MapAnimLevelUp_ResetLcd
MapAnimLevelUp_ResetLcd: @ 0x0807F190
...
_0807F1A8: .4byte gLCDControlBuffer
	...
	THUMB_FUNC_END MapAnimLevelUp_ResetLcd

	THUMB_FUNC_START MapAnimLevelUp_InitDisplay
MapAnimLevelUp_InitDisplay: @ 0x0807F1AC
	push {r4, r5, r6, lr}
	sub sp, #4
	adds r5, r0, #0
...
_0807F2B0: .4byte gUnknown_03004980
	...
	THUMB_FUNC_END MapAnimLevelUp_InitDisplay
...
_0807F308: .4byte gUnknown_089AC5CC
	...
	THUMB_FUNC_START MapAnimLevelUp_PullUpWindow
MapAnimLevelUp_PullUpWindow: @ 0x0807F30C
	push {r4, lr}
	adds r4, r0, #0
	ldrh r0, [r4, #0x32]
	adds r0, #8
...
_0807F350: .4byte gUnknown_03004980
	...
	THUMB_FUNC_END MapAnimLevelUp_PullUpWindow

	THUMB_FUNC_START MapAnimLevelUp_PullOffWindow
MapAnimLevelUp_PullOffWindow: @ 0x0807F354
	push {r4, lr}
	adds r4, r0, #0
	ldrh r0, [r4, #0x32]
	subs r0, #8
...
_0807F398: .4byte gUnknown_03004980
	...
	THUMB_FUNC_END MapAnimLevelUp_PullOffWindow

	THUMB_FUNC_START MapAnimLevelUp_DisplayStatUp
MapAnimLevelUp_DisplayStatUp: @ 0x0807F39C
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	sub sp, #4
...
_0807F474: .4byte gRAMChapterData
	...
	THUMB_FUNC_END MapAnimLevelUp_DisplayStatUp
