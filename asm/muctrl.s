...
_08079F30:
	mov r1, sl
	lsls r0, r1, #0x18
	ldr r2, _08079F80  @ gBmMapMagicSealed
	ldr r1, [r2]
	asrs r0, r0, #0x16
	adds r0, r0, r1
	ldr r3, [sp, #4]
...
_08079F80: .4byte gBmMapMagicSealed
...
sub_807A358: @ 0x0807A358
	...
	movs r1, #0
	ldrsb r1, [r0, r1]
	ldr r0, _0807A3C0  @ gBmMapMagicSealed
	ldr r0, [r0]
	lsls r1, r1, #2
	adds r1, r1, r0
	adds r3, r4, #0
	...
	b _0807A3E8
	.align 2, 0
_0807A3C0: .4byte gBmMapMagicSealed
...
_0807A3EC:
	...
	movs r1, #0
	ldrsb r1, [r0, r1]
	ldr r0, _0807A488  @ gBmMapMagicSealed
	ldr r0, [r0]
	lsls r1, r1, #2
	adds r1, r1, r0
	adds r0, r4, #0
...
_0807A488: .4byte gBmMapMagicSealed
_0807A48C:
	adds r0, r4, #0
...
_0807A554:
	...
	cmp r0, #0
	bne _0807A5B6
	ldr r0, _0807A5F8  @ gBmMapMagicSealed
	ldr r0, [r0]
	adds r0, r3, r0
	ldr r0, [r0]
	adds r0, r0, r2
...
_0807A5F8: .4byte gBmMapMagicSealed
