...
StartSpellBG_IvaldiBG1: @ 0x080659AC
	push {r4, lr}
	adds r4, r0, #0
	ldr r1, _080659F8  @ gEfxBgSemaphore
	ldr r0, [r1]
	adds r0, #1
	str r0, [r1]
	...
	bx r0
	.align 2, 0
_080659F8: .4byte gEfxBgSemaphore
...
_08065A74:
	...
	bx r0
	.align 2, 0
_08065A7C: .4byte gEfxBgSemaphore
...
StartSpellBG_IvaldiBG2: @ 0x08065A80
	push {r4, r5, lr}
	adds r5, r0, #0
	ldr r1, _08065AD4  @ gEfxBgSemaphore
	ldr r0, [r1]
	adds r0, #1
	str r0, [r1]
	...
	bx r0
	.align 2, 0
_08065AD4: .4byte gEfxBgSemaphore
...
_08065B48:
	...
	bx r0
	.align 2, 0
_08065B50: .4byte gEfxBgSemaphore
...
StartSpellBG_IvaldiBG3: @ 0x08065B54
	...
	bx r0
	.align 2, 0
_08065BA0: .4byte gEfxBgSemaphore
...
_08065C2E:
	...
	bx r0
	.align 2, 0
_08065C34: .4byte gEfxBgSemaphore
...
StartSpellBG_IvaldiBG4: @ 0x08065C38
	push {r4, lr}
	adds r4, r0, #0
	ldr r1, _08065C88  @ gEfxBgSemaphore
	ldr r0, [r1]
	adds r0, #1
	str r0, [r1]
	...
	bx r0
	.align 2, 0
_08065C88: .4byte gEfxBgSemaphore
...
_08065D76:
	...
	bx r0
	.align 2, 0
_08065D80: .4byte gEfxBgSemaphore
...
_08065DF0: .4byte gEfxBgSemaphore
...
_08065EEA:
	...
	cmp r1, r0
	bne _08065F04
	ldr r1, _08065F0C  @ gEfxBgSemaphore
	ldr r0, [r1]
	subs r0, #1
	str r0, [r1]
	adds r0, r4, #0
...
_08065F04:
	...
	bx r0
	.align 2, 0
_08065F0C: .4byte gEfxBgSemaphore
...
_08065F5C: .4byte gEfxBgSemaphore
...
_0806603C:
	...
	cmp r1, r0
	bne _08066052
	ldr r1, _0806605C  @ gEfxBgSemaphore
	ldr r0, [r1]
	subs r0, #1
	str r0, [r1]
	adds r0, r4, #0
...
_08066052:
	...
	bx r0
	.align 2, 0
_0806605C: .4byte gEfxBgSemaphore
...
_080660AC: .4byte gEfxBgSemaphore
...
_08066236:
	...
	cmp r1, r0
	bne _0806624C
	ldr r1, _08066254  @ gEfxBgSemaphore
	ldr r0, [r1]
	subs r0, #1
	str r0, [r1]
	adds r0, r2, #0
...
_0806624C:
	...
	bx r0
	.align 2, 0
_08066254: .4byte gEfxBgSemaphore
...
sub_806635C: @ 0x0806635C
	...
	cmp r0, r1
	bne _08066386
	ldr r0, _0806638C  @ gEfxBgSemaphore
	ldr r1, [r0]
	subs r1, #1
	str r1, [r0]
	ldr r0, [r4, #0x60]
...
_08066386:
	...
	bx r0
	.align 2, 0
_0806638C: .4byte gEfxBgSemaphore
...
sub_8066434: @ 0x08066434
	...
	cmp r0, r1
	bne _08066466
	ldr r0, _0806646C  @ gEfxBgSemaphore
	ldr r1, [r0]
	subs r1, #1
	str r1, [r0]
	ldr r0, [r4, #0x60]
...
_08066466:
	...
	bx r0
	.align 2, 0
_0806646C: .4byte gEfxBgSemaphore
...
sub_8066470: @ 0x08066470
	...
	adds r6, r1, #0
	adds r5, r2, #0
	ldr r1, _080664A0  @ gEfxBgSemaphore
	ldr r0, [r1]
	adds r0, #1
	str r0, [r1]
	...
	bx r0
	.align 2, 0
_080664A0: .4byte gEfxBgSemaphore
...
sub_80664A8: @ 0x080664A8
	...
	cmp r0, r1
	ble _080664FE
	ldr r1, _08066510  @ gEfxBgSemaphore
	ldr r0, [r1]
	subs r0, #1
	str r0, [r1]
	adds r0, r6, #0
...
_0806650C: .4byte gEfxPal
_08066510: .4byte gEfxBgSemaphore
