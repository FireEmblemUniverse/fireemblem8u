...
_0803B866:
	...
	ldr r1, _0803B8E8  @ gBmMapMagicSealed
_0803B882:
	mov r2, ip
	ldr r0, [r2]
	adds r0, r4, r0
...
_0803B8E8: .4byte gBmMapMagicSealed
_0803B8EC:
	movs r0, #1
_0803B8EE:
	pop {r3, r4, r5}
...
_0803BB1E:
	...
	cmp r1, r0
	bge _0803BB52
	ldr r0, _0803BBE8  @ gBmMapMagicSealed
	ldr r0, [r0]
	add r0, r8
	ldr r0, [r0]
	adds r0, r0, r3
...
_0803BBE8: .4byte gBmMapMagicSealed
...
_0803BD0A:
	...
	cmp r1, r0
	bge _0803BD3E
	ldr r0, _0803BDD4  @ gBmMapMagicSealed
	ldr r0, [r0]
	add r0, r8
	ldr r0, [r0]
	adds r0, r0, r3
...
_0803BDD4: .4byte gBmMapMagicSealed
...
sub_803BDE0: @ 0x0803BDE0
	...
	ldr r1, [r0]
	adds r1, r1, r4
	ldr r7, _0803BE38  @ gBmMapMagicSealed
	ldr r0, [r7]
	adds r0, r2, r0
	ldr r0, [r0]
	adds r0, r0, r4
...
_0803BE38: .4byte gBmMapMagicSealed
...
_0803BE70:
	...
	mov sl, r2
	ldr r7, _0803BF28  @ gBmMapMagicSealed
	mov r9, r7
...
_0803BF28: .4byte gBmMapMagicSealed
...
_0803C2EE:
	...
	bl sub_803E27C
	adds r4, r4, r0
	ldr r0, _0803C34C  @ gBmMapMagicSealed
	ldr r0, [r0]
	adds r0, r7, r0
	ldr r0, [r0]
	adds r0, r0, r5
...
_0803C34C: .4byte gBmMapMagicSealed
...
sub_803CF60: @ 0x0803CF60
	...
	asrs r0, r0, #0x18
	subs r4, r4, r0
	ldr r0, _0803CFAC  @ gBmMapMagicSealed
	ldr r0, [r0]
	adds r5, r5, r0
	ldr r0, [r5]
	adds r0, r0, r6
...
_0803CFAC: .4byte gBmMapMagicSealed
...
sub_803DE5C: @ 0x0803DE5C
	...
	asrs r0, r0, #0x18
	subs r4, r4, r0
	ldr r0, _0803DEBC  @ gBmMapMagicSealed
	ldr r0, [r0]
	adds r5, r5, r0
	ldr r0, [r5]
	adds r0, r0, r6
...
_0803DEBC: .4byte gBmMapMagicSealed
...
sub_803E114: @ 0x0803E114
	...
	movs r0, #0x11
	ldrsb r0, [r2, r0]
	ldr r1, _0803E148  @ gBmMapMagicSealed
	ldr r1, [r1]
	lsls r0, r0, #2
	adds r0, r0, r1
	movs r1, #0x10
...
_0803E148: .4byte gBmMapMagicSealed
...
AiInitDangerMap: @ 0x0803E2F4
	...
	movs r0, #1
	strb r0, [r1]
	ldr r0, _0803E31C  @ gBmMapMagicSealed
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	bl sub_803E320
...
_0803E31C: .4byte gBmMapMagicSealed
...
_0803E3E2:
	...
	adds r0, r6, #0
	bl GetUnitPower
	ldr r1, _0803E444  @ gBmMapMagicSealed
	ldr r1, [r1]
	adds r1, r5, r1
	ldr r1, [r1]
	adds r1, r1, r4
...
_0803E444: .4byte gBmMapMagicSealed
...
sub_803E448: @ 0x0803E448
	...
	lsls r2, r2, #0x18
	lsrs r2, r2, #0x18
	ldr r3, _0803E464  @ gBmMapMagicSealed
	ldr r3, [r3]
	lsls r1, r1, #2
	adds r1, r1, r3
	ldr r1, [r1]
	...
	b _0803E46A
	.align 2, 0
_0803E464: .4byte gBmMapMagicSealed
_0803E468:
	movs r0, #0
_0803E46A:
	pop {r1}
...
sub_803EA58: @ 0x0803EA58
	...
	ldr r3, [sp, #0xc]
	strh r0, [r3]
	ldr r0, _0803EB94  @ gBmMapMagicSealed
	ldr r0, [r0]
	movs r1, #0
	bl BmMapFill
	movs r4, #1
...
_0803EB70:
	...
	bx r0
	.align 2, 0
_0803EB94: .4byte gBmMapMagicSealed
...
_0803FB3A:
	...
	bl sub_803E27C
	adds r4, r4, r0
	ldr r0, _0803FB9C  @ gBmMapMagicSealed
	ldr r0, [r0]
	adds r0, r6, r0
	ldr r0, [r0]
	adds r0, r0, r5
...
_0803FB9C: .4byte gBmMapMagicSealed
