...
NextRN: @ 0x08000B88
	push {r4, lr}
	ldr r3, _08000BC4  @ gUnknown_03000000
	ldrh r2, [r3, #2]
	lsls r1, r2, #0xb
	ldrh r0, [r3]
	lsrs r0, r0, #5
...
_08000BAE:
	...
	bx r1
	.align 2, 0
_08000BC4: .4byte gUnknown_03000000
...
sub_8000BC8: @ 0x08000BC8
	...
	bl __modsi3
	adds r6, r0, #0
	ldr r1, _08000C30  @ gUnknown_03000000
	ands r0, r4
	lsls r0, r0, #1
	add r0, sp
	ldrh r0, [r0]
...
_08000C30: .4byte gUnknown_03000000

	THUMB_FUNC_START LoadRNState
LoadRNState: @ 0x08000C34
	ldr r2, _08000C48  @ gUnknown_03000000
	ldrh r1, [r0]
	strh r1, [r2]
	adds r0, #2
	ldrh r1, [r0]
	...
	bx lr
	.align 2, 0
_08000C48: .4byte gUnknown_03000000

	THUMB_FUNC_START StoreRNState
StoreRNState: @ 0x08000C4C
	ldr r2, _08000C60  @ gUnknown_03000000
	ldrh r1, [r2]
	strh r1, [r0]
	adds r0, #2
	ldrh r1, [r2, #2]
	...
	bx lr
	.align 2, 0
_08000C60: .4byte gUnknown_03000000
...
SetOtherRNState: @ 0x08000CDC
	ldr r1, _08000CE4  @ gUnknown_03000008
	str r0, [r1]
	bx lr
	.align 2, 0
_08000CE4: .4byte gUnknown_03000008

	THUMB_FUNC_START GetOtherRN
GetOtherRN: @ 0x08000CE8
	ldr r1, _08000CFC  @ gUnknown_03000008
	ldr r2, [r1]
	lsls r2, r2, #2
	adds r0, r2, #2
	adds r2, #3
	...
	bx lr
	.align 2, 0
_08000CFC: .4byte gUnknown_03000008
